...
export const bedImages = [
  {
    src: `${imagePath}/athens-koukaki-bed.jpeg`,
    alt: 'Athens Koukaki Airbnb bed',
    caption: "This was the bed that I had in an Airbnb in Athens, Greece. Due to the genius design of the bed-frame, my feet couldn't stretch over the end because of that lip, and I absolutely hated it.",
  },
  {
    src: `${imagePath}/sofia-bed.jpeg`,
