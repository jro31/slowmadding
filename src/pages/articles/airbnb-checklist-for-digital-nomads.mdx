...
The better the cooking facilities in the Airbnb and the more vegan-friendly the supermarkets are, the less important it is to have vegan restaurants near to the room. Even then, I love having vegan or vegan-friendly restaurants nearby. Particularly on days I'm working and want to be able to get lunch quickly in order to maximise my break, I always look-up the local vegan restaurants before committing to a room. If there are none nearby, I usually won't stay there.
...
Having a washing machine in the room is always a nice luxury. I would never consider it essential. Sitting in the local launderette for an hour can even be quite relaxing, and failing that I've at times resorted to hand-washing my clothes in the shower with shampoo. But it is nice to have a machine in the unit to do if for you.

Also worth considering drying facilities. Is there either a tumble dryer, or at least a place to hang your clothes to dry them?

### Is the room on the ground floor?

Ground floor units are less secure that rooms on higher floors because unwanted guests can climb in through the windows, and they're the first rooms that thieves will find when breaking into a building, while also being easier to escape.

They're also less private if people at ground-level can see in, perhaps forcing you to keep the curtains closed all day.

That doesn't mean you should avoid ground floor rooms altogether, but do consider the area - is it a safe area? If not, are the windows sufficiently secure? For example, are there bars on the windows? And is the room at the front or the back of the building?

If it's at the front with people walking past all day, what kind of curtains does the room have? If your choice is to have no privacy or to have the black-out curtains in the room closed all day, you're probably not going to have a good time.
...
I used to carry a towel with me, but for about a year it just sat in my suitcase unused because every Airbnb and hotel I stayed at provided one. On rare occasions you will come across rooms that don't provide towels. If you don't carry one in your suitcase it's worth checking.

### How fast is the wifi?

This question is becoming less and less relevant. Almost everywhere in the world now has wifi sufficient for video calls, and on the rare occasion you stay somewhere that doesn't, using your data plan to tether to your phone is often a viable alternative.
...
Something else that will be mentioned a lot is outside noise. As someone that used to live on a main road, opposite to a noisy pub, I have a very high tolerance for outside noise. Cars driving by all night doesn't affect me at all.

I can be fairly confident that if other guests aren't mentioning noise in their reviews, then it's not going to be a problem for me. If it does come up a lot though, then I'll reconsider. If you're sensitive to outside noise you might want to put this much higher on your list.
