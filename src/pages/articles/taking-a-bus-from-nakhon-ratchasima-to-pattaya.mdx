...
{/* TODO: Add link to Pattaya to Nakhon Ratchasima article saying to go in the other direction... */}

export const meta = {
  author: 'Jethro Williams',
  date: '2024-02-23T18:15:00+07:00', // TODO: Update this
...
export const whereToBuyATicketAndCatchTheBusImages = [
  ...
  },
  {
    ...
    caption: 'This is a screenshot of Nakhon Ratchasima bus terminal 2 that I took from Google Maps. Gate 8 is on the eastern side of the western terminal building, about a third of the way up.',
  },
  {
...
Pattaya, in Chonburi province, is one of Thailand's most visited cities by foreigners, and is frankly, sickenly touristy. Nakhon Ratchasima on the other hand, despite being the bigger of the two cities and the largest in Isaan, has very little tourist presence and so finding information on travelling between the two cities can be a little challenging.

There are two daily direct buses between Nakhon Ratchasima (also known as Korat) and Pattaya. They departs from Nakhon Ratchasima's Bus Terminal 2 and are run by a company called Sri Mongkol.
...
While Sri Mongkol's ticket office is conveniently located in the main bus terminal, in Pattaya they have an office nowhere notable in particular. The <ExternalLink url='https://maps.app.goo.gl/SsuV4yVFqkZKsCRn8'>Sri Mongkol ticket office in Pattaya</ExternalLink> is on Pattaya 3rd Road, and this is where the bus arrives and where you'll be dropped off.
...
Because the Pattaya ticket office is has nothing notable around, there were no tuk-tuks or taxis waiting to take arriving passengers to their hotels, just a couple of motorcycle taxis. I tried multiple times to get a taxi with Grab, but at this time of day there was a lot of traffic and the only drivers accepting were miles away with other stops to make first.

Eventually I conceded and got a motorcycle taxi with my suitcase, which wasn't as bad as I was expecting, and we were at my room in no time. Other passengers were still there when I left, and appeared somewhat stranded, so beware that this isn't like arriving on most buses in Thailand where you're immediately hounded by taxis and tuk-tuks. You may find nothing at all.

Other than that, this was a really comfortable and seemless journey. I have nothing bad to say about the bus company, and if you're lucky enough to be on a bus with massage chairs, then get ready to feel nice and relaxed.
