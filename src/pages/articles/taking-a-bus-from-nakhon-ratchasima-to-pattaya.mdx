...
export const imagePath = '/images/articles/taking-a-bus-from-nakhon-ratchasima-to-pattaya'
...
export const whereToBuyATicketAndCatchTheBusImages = [
  ...
  {
    src: `${imagePath}/where-to-buy-a-ticket-and-catch-the-bus/gate-8.jpeg`,
  ...
  {
    src: `${imagePath}/where-to-buy-a-ticket-and-catch-the-bus/satellite-view.png`,
  ...
  {
    src: `${imagePath}/where-to-buy-a-ticket-and-catch-the-bus/the-bus.jpeg`,
...
export const onTheBusImages = [
  {
    src: `${imagePath}/on-the-bus/on-board.jpeg`,
  ...
  {
    src: `${imagePath}/on-the-bus/massage.jpeg`,
