...
export const meta = {
  ...
  description: "Sofia is the capital city of one of the cheapest countries in the EU. You'd think that would make it perfect for a European digital nomad, wouldn't you?",
  keywords: ['Bulgaria'],
}
...
If you're someone that's comfortable sitting at a bar alone and chatting to people, then McCarthys is a very good pub for doing that.

If you're willing to pay for an event, then the <ExternalLink url='https://pubcrawlsofia.com/'>Sofia Pub Crawl</ExternalLink> could be something you could try. I only know of it because I spoke to one of the organisers when they came into McCarthys, and honestly it looked very dry, but I think it was a bunch of strangers who hadn't drunk anything yet. I'm sure it picked-up a bit once the alcohol flowed a bit more.

I'm unaware of anything else going on in Sofia.

## Where to run in Sofia

Sofia has three parks that are suitable for running within easy walk of the city centre.
...
The first South Park is the smallest of the three. A lot of people use it for exercise, while a lot of other people use it for smoking. It's not really great for running because none of the main paths make any kind of loop, so you have to make your own loop to save going backwards and forwards. Got for short or slow runs when you don't want to worry about getting lost or crossing roads, but for longer runs looks elsewhere.
...
Borisova Gradina Park is bigger than both of the South Parks combined, and it much more of an untamed, wilderness park. It's great for trail running, although very easy to get lost. The main downside is that it's dissected by a couple of very busy roads. In some places there are tunnels underneath them, but in others you have to cross, which is a little unnerving seeing as how fast the traffic goes.
...
export const runningImages = [
  ...
  },
  {
    ...
    caption: "Borisova Gradina Park is the best of the three parks I've mentioned here. The trails get far narrower and windier if that's what you're looking for.",
  },
  {
