...
import cityClockTowerImage from '#/chiang-rai-for-digital-nomads/city/clock-tower.jpeg'

import saikaewBedImage from '#/chiang-rai-for-digital-nomads/saikaew-resort/bed.jpeg'
import saikaewDeskImage from '#/chiang-rai-for-digital-nomads/saikaew-resort/desk.jpeg'
import saikaewLakeImage from '#/chiang-rai-for-digital-nomads/saikaew-resort/lake.jpeg'
import saikaewRoomImage from '#/chiang-rai-for-digital-nomads/saikaew-resort/room.jpeg'
import saikaewSelfieImage from '#/chiang-rai-for-digital-nomads/saikaew-resort/selfie.jpeg'
import saikaewToiletImage from '#/chiang-rai-for-digital-nomads/saikaew-resort/toilet.jpeg'
import saikaewViewImage from '#/chiang-rai-for-digital-nomads/saikaew-resort/view.jpeg'

import kundaBurgerImage from '#/chiang-rai-for-digital-nomads/kunda/jalapeno-burger.jpeg'
import kundaBunlessComboImage from '#/chiang-rai-for-digital-nomads/kunda/bunless-combo.jpeg'
import kundaViewImage from '#/chiang-rai-for-digital-nomads/kunda/view.jpeg'

import vegMeUpVampireImage from '#/chiang-rai-for-digital-nomads/veg-me-up/vampire-blood-smoothie-bowl.jpeg'
import vegMeUpMojitoImage from '#/chiang-rai-for-digital-nomads/veg-me-up/mojito.jpeg'
import vegMeUpChaochelaImage from '#/chiang-rai-for-digital-nomads/veg-me-up/chaochela-smoothie-bowl.jpeg'

import buffet1Image from '#/chiang-rai-for-digital-nomads/oasis/buffet-1.jpeg'
import buffet2Image from '#/chiang-rai-for-digital-nomads/oasis/buffet-2.jpeg'
import oasis2013Image from '#/chiang-rai-for-digital-nomads/oasis/2013.jpg'

import heavenBurgerVeganBreakfastPlateImage from '#/chiang-rai-for-digital-nomads/heaven-burger/vegan-breakfast-plate.jpeg'
import heavenBurgerFriedCrispyMushroomImage from '#/chiang-rai-for-digital-nomads/heaven-burger/fried-crispy-mushroom.jpeg'
import heavenBurgerMixedBerrySmoothieImage from '#/chiang-rai-for-digital-nomads/heaven-burger/mixed-berry-smoothie.jpeg'
import heavenBurgerAvocadoMushroomSandwichImage from '#/chiang-rai-for-digital-nomads/heaven-burger/avocado-mushroom-sandwich.jpeg'

import runningStravaImage from '#/chiang-rai-for-digital-nomads/running/strava.jpeg'
...
export const cityImages = [
  {
    src: cityClockTowerImage,
    alt: 'Chiang Rai clock tower',
    caption: 'The Chiang Rai clock tower marks the centre of the city.'
  }
]

export const saikaewResortImages = [
  {
    src: saikaewRoomImage,
    alt: 'Saikaew Resort double room',
    caption: "With nothing but fish able to see in the room, I didn't bother closing the curtains at night, meaning I woke up to this view everyday.",
  },
  {
  ...
  },
  {
    ...
    caption: "A fine example of why I don't take selfies.",
  },
  {
    src: saikaewBedImage,
...
export const oasisImages = [
  {
    src: buffet1Image,
    alt: 'Oasis Vegetaurant buffet',
    caption: 'From the buffet, this plate cost me 80 baht.',
  },
  {
    src: buffet2Image,
    alt: 'Oasis Vegetaurant buffet',
    caption: 'This one was 90 baht.',
  },
  {
    src: oasis2013Image,
    alt: 'Oasis Vegetaurant buffet',
    caption: 'A throwback to when I ate here in 2013.',
  },
]

export const heavenBurgerImages = [
  {
    src: heavenBurgerVeganBreakfastPlateImage,
    alt: 'Heaven Burger vegan breakfast plate',
    caption: "This vegan breakfast plate is the most expensive item on the vegan menu at 179 baht. At first glance, it looks slightly peculiar. Who'd have thought a plate containing mango and baked beans would work? But somehow, it really does.",
  },
  {
    src: heavenBurgerFriedCrispyMushroomImage,
    alt: 'Heaven Burger fried crispy mushroom with teriyaki sauce on vegan burger bun',
    caption: 'This one is fried crispy mushroom with teriyaki sauce on a vegan burger bun, and costs 149 baht.',
  },
  {
    src: heavenBurgerMixedBerrySmoothieImage,
    alt: 'Heaven Burger mixed berry smoothie',
    caption: 'A mixed berry smoothie for 60 baht.',
  },
  {
    src: heavenBurgerAvocadoMushroomSandwichImage,
    alt: 'Heaven Burger avocado mushroom sandwich',
    caption: 'This avocado mushroom sandwich with fries will cost you 129 baht.',
  },
]
...
export const runningImages = [
  {
    ...
    url: 'https://www.strava.com/activities/8137341605',
  },
]
...
<AccommodationAddress name='220 Moo 24 Sankhongluang Rd' url='https://goo.gl/maps/Th1xiWAneLPnfyFM7' />
...
The rooms are cleaned daily, and I really appreciated the location of this resort. You're about a 25 minute walk from the centre of town. A perfectly pleasant, if unremarkable walk. Being this far out of the centre gives you a much more "local" experience. You're too far from the nearest 7-11 to go there for all your needs, so you get to know the local shops and businesses instead. And if you run, it's less than 10 minutes before you're at the old airport (more on that <Link href='#where-to-run-in-chiang-rai'>below</Link>).
...
<ImageGallery images={saikaewResortImages} />
...
<ExternalLink url="https://www.happycow.net/searchmap?s=3&location=Chiang+Rai%2C+Thailand&metric=mi&limit=81&order=rating&lat=19.9072&lng=99.831&zoom=11&page=1">Happy Cow</ExternalLink> is my go-to resource for finding vegan restaurants in most places in the world, and Chiang Rai is no different. Searching for vegan food on local delivery apps like Grab and FoodPanda is an alternative choice. Even if you have no intention of ordering from the app, it can let you know which places offer vegan food. It's also worth noting the fruit market. It's a short walk from the bus station, and sells whole fruits, but also some pre-cut fruit, often mixed into fruit salad (expect to pay about 50 baht). Getting one of these with some nuts and seeds from 7-11, and you've got a substantial and healthy meal.

Vegan restaurants in Chiang Rai go beyond what I'll mention here, but my favourite places were:
...
There's at least one other such restaurant in Chiang Rai (<ExternalLink url='https://www.happycow.net/reviews/tamachat-chiang-rai-5147'>Tamachat</ExternalLink> comes to mind), but Oasis holds a special place in my heart because when I first came to Chiang Rai in 2013, this was my best, and perhaps only source of vegan food.
...
<ImageGallery images={oasisImages} />

<ExternalLink url='https://www.happycow.net/reviews/oasis-vegetaurant-chiang-rai-5146'>Visit Oasis Vegetaurant on Happy Cow</ExternalLink>
...
<ImageGallery images={heavenBurgerImages} />

<ExternalLink url='https://www.happycow.net/reviews/heaven-burger-chiang-rai-293904'>Visit Heaven Burger on Happy Cow</ExternalLink>
