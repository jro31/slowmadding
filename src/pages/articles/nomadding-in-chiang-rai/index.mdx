...
export const saikeawResortDetails = {
  ...
  description: [
    ...
    "You're about a 25 minute walk from the centre of town. A perfectly pleasant, if unremarkable walk. But being this far out of the centre gave you a much more &#34;local&#34; experience. You're too far from the nearest 7-11 to go there for all your needs, so yu get to know the local shops and businesses instead.",
