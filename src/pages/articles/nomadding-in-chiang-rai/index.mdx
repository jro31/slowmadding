...
export const meta = {
  ...
  date: '2022-12-11', // TODO: Update this
...
export const saikeawResortDetails = {
  ...
  description: [
    ...
    "You're about a 25 minute walk from the centre of town. A perfectly pleasant, if unremarkable walk. But being this far out of the centre gave you a much more &#34;local&#34; experience. You're too far from the nearest 7-11 to go there for all your needs, so you get to know the local shops and businesses instead. And if you run, it's less than 10 minutes before you're at the old airport (more on that <a href='#where-to-run-in-chiang-rai'>below</a>).",
...
Although Singha Park looked great, I didn't have my own transport, and I like running to be as simple as possible. If I can start running as soon as I step out my front door, then that's perfect. The fewer barriers there are, the more likely I am to run.

Looking at a map, the old airport was just a 15-minute walk from my room.

I walked down there to do a bit of recon and... man, that looks perfect, so they next day I gave it a go. And it really is a great place to run.

I'll add the caveat that I have a slightly sadomasochistic attitude to running. I see it as a time work and to push yourself. You only know what you're capable of when you push yourself, both physically and mentally, when you reach your limits and all you have to do to make the pain go away, is to stop running. That's when you feel alive, so unlike most people, when I'm in this region I prefer to run at the hottest times of day.

From what I saw when walking by at other times of day, the airport gets busy in the early mornings before it gets too hot, and even more so in the evenings, so beware that you won't be running alone if you choose those times.
