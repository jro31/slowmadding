...
TODO: Add a gallery of any other Chiang Rai photos you want to show
...
You're about a 25 minute walk from the centre of town. A perfectly pleasant, if unremarkable walk. But being this far out of the centre gave you a much more "local" experience. You're too far from the nearest 7-11 to go there for all your needs, so you get to know the local shops and businesses instead. And if you run, it's less than 10 minutes before you're at the old airport (more on that <Link href='#where-to-run-in-chiang-rai'>below</Link>).
...
Oasis is your typical "local" Thai vegan restaurant buffet. It has made-to-order food too, but I've never felt the need to order any because the buffet's always been so good. The menu is 100% vegan, so you can order anything with confidence, and if you come here with 100 baht, you'll be leaving with change.
...
As with all places of this type, the food isn't going to blow you away. It's more a place that you can come everyday, without a worry that you're overspending. But the quality is certainly good enough that you'll be happy to come back again.
...
It has an entirely separate vegan menu, and if you order from it, the staff will ask you if you're vegan or vegetarian. Unlike a lot of places, they get the difference, so I never had any concern about what was being served.

Equally important, was that I found in Chiang Rai, the hours that restaurants claim to be open, and the hours that restaurants are open, aren't always the same thing. Heaven Burger was reliable. It says that it's open until 9pm every night, and it always was.

So after a day working on my laptop, when I might not finish until 7:30pm, it was nice to know that I could rely on this place to still be open.

The vegan menu is pretty big, containing 14 items (although the seven non-burger type items weren't always available), so you get plenty of variety if you come here multiple times, as I did. The quality was great, and the most expensive item on the vegan menu was 179 baht (although the burgers start from 129 baht). So you can come here, get a burger and chips with a smoothie, and still pay less than 200 baht.
