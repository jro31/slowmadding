...
import clockTowerImage from './clock-tower.jpeg'
...
import buffet1 from './oasis/buffet-1.jpeg'
import buffet2 from './oasis/buffet-2.jpeg'
import oasis2013Image from './oasis/2013.jpg'

import heavenBurgerVeganBreakfastPlate from './heaven-burger/vegan-breakfast-plate.jpeg'
import heavenBurgerFriedCrispyMushroom from './heaven-burger/fried-crispy-mushroom.jpeg'
import heavenBurgerMixedBerrySmoothie from './heaven-burger/mixed-berry-smoothie.jpeg'
import heavenBurgerAvocadoMushroomSandwich from './heaven-burger/avocado-mushroom-sandwich.jpeg'

import stravaImage from './strava.jpeg'

export const meta = {
  author: 'Jethro Williams',
  date: '2022-12-29', // TODO: Update this
  title: 'Nomadding in Chiang Rai',
  description: 'What to expect from Chiang Rai as a nomadding city.',
  coverImage: { image: clockTowerImage, alt: 'Chiang Rai Clock Tower' }
}
...
export const heavenBurgerImages = [
  {
    src: heavenBurgerVeganBreakfastPlate,
  ...
  {
    src: heavenBurgerFriedCrispyMushroom,
    alt: 'Heaven Burger fried crispy mushroom with teriyaki sauce on vegan burger bun',
    caption: 'This one is fried crisy mushroom with teriyaki sauce on a vegan burger bun, and costs 149 baht.',
  },
  {
    src: heavenBurgerMixedBerrySmoothie,
    alt: 'Heaven Burger mixed berry smoothie',
    caption: 'A mixed berry smoothie for 60 baht.',
  },
  {
    src: heavenBurgerAvocadoMushroomSandwich,
...
Apart from 7-11 (of which there are fewer than in other parts of Thailand) you see few, if any chain businesses in Chiang Rai. Instead, it's small businesses; family-run or with just one or two employees.
...
The rooms are all on the edge of the lake that gives this property its serenity. You'll have a balcony that goes into the lake, where you can just sit and drink tea, or read a book, or smoke some weed, or do yoga or meditate.
...
As long as you're mindful to close your doors in the evening, they aren't a problem though. There is a fan that can be pointed at your bed, and this will prevent any mosquitos that did make it into your room and that escaped the spiders, from landing on you during the night, as they still air to land.

I did also have a neighbour knock on my door to tell me that he'd just seen a very big snake. That wasn't very welcome, as I was about to go on the balcony and meditate, so could have done without the thought of a large snake in the back of my mind. I never saw it though.
...
I like to eat a good amount of fruit daily, or at the very least on every other day. There are street vendors sporadically dotted around Chiang Rai selling the usual fruits such as pineapple, watermelon and papaya, and then you can also go to the fruit market. But when you're in the mood for something a little more, Chiang Rai can leave you lacking.
