...
When I lived in Bangkok, I used to rent a condo where the size was written into the contract as (just under) 29m(squared). I've always assumed therefore, that measurement was accurate. It was quite a compact place, but it had one bedroom, a good kitchen, and a dining area within the living room.

So when I stay somewhere that describes itself as 35m(squared), but it's a studio without any dining area and almost no free space, I'm slightly dubious. It felt significantly smaller than my Bangkok condo, to the point that I had to rearrange the furniture just to have the space to do yoga.
