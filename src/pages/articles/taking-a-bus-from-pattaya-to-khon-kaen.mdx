...
export const pattanaImages = [
  {
    ...
    caption: "With the big 'Dirt Power Shop' sign, this doesn't really look like a bus ticket office from a distance. Only once you walk across the petrol station forecourt do you get close enough to see the bus times and realise it is.",
  },
]
