...
export const suTingSianImages = [
  ...
  },
  {
    ...
    caption: "This is listed on the menu as Yong Tau foo, and no I didn't know what that means when I ordered it either. Turns-out it means a load of weird things in a red liquid. I quite liked it, and it only cost 45 baht. Interestingly enough, after taking this photo I dropped my phone in it.",
  },
  {
  ...
  },
  {
    ...
    caption: "Western food is not their forte. This is a spaghettic carbonara with mushroom sauce, and though it actually looks pretty nice, I don't recommend it. The sauce tasted like salad cream. It probably was salad cream. Yours for 70 baht.",
  },
  {
    src: `${imagePath}/vegan-food/su-ting-sian/pad-thai.jpeg`,
    alt: 'Su Ting Sian pad Thai',
    caption: "The other dish I don't recommend here is the pad Thai. For some reason it's the first dish many people overseas think of when they think of Thai food, but it defintely isn't the best, and here it was particularly average. Although at 45 baht you can't complain.",
  },
  {
...
export const manomonResidenceImages = [
  ...
  {
    src: `${imagePath}/manomon-residence/windows.jpeg`,
