...
Completely. As there are no tourists, there are no tourist scame. I wasn't aware of any crime when I was here, and felt very safe walking around in the middle of the night.
...
Instead, there's a small cluster of foreigner-aimed bars in front of the <ExternalLink url='https://maps.app.goo.gl/NAEq7LS7BxSNqvDk7'>Pullman Hotel</ExternalLink>. And by small, I do mean small. There's at most a dozen of them. If you've come here from Pattaya, or even Udon Thani, you might be shocked at how tame it is, but they're still a nice place to come and start chatting to people.
...
export const runningImages = [
  {
    ...
    caption:
    "Coming here to run, or even to walk, Bueng Kaen Nakhon Reservoir is lovely. This is the inner path that I tend to run along, but there's also an outer path shared by pedestrians and bicycles that has fewer obstacles, so is perhaps better suited for faster runners.",
  },
]
...
export const suTingSianImages = [
  ...
  },
  {
    ...
    caption: "And this one is known as Yong Tau foo, and no I didn't know what that meant when I ordered it either. Turns-out it means a load of weird things in a red liquid. I quite liked it, and it only cost 45 baht. Interestingly enough, after taking this photo I dropped my phone in it.",
  },
  {
  ...
  },
  {
    ...
    caption: "'Stir fried with basil leaves' is how this is listed in the menu. Stir fried what I never found out, but I like a bit of uncertainty with my meal. Whatever it is it costs 45 baht.",
  },
  {
  ...
  },
  {
    ...
    caption: "The other dish I don't recommend here is the Pad Thai. For some reason it's the first dish many people overseas think of when they think of Thai food, but it definitely isn't the best, and here it's particularly average. Although at only 45 baht you can't complain.",
  },
  {
...
The bathroom is especially nice considering the low price of the room, and you also have another sink on the balcony more suitable for things like washing up. The wifi in the room is fast and reliable. I'm yet to have any connection issues while staying here, and I really like the location. Most of the places you're going to want to go to are within a 25 to 30 minute walk, including Central Plaza, Bueng Kaen Nakhon Reservoir, and most of the vegan restaurants detailed above.
