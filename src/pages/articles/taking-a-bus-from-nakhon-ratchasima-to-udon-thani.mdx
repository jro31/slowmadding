...
export const takingTheBusOnBoardImages = [
  ...
  },
  {
    ...
    alt: 'On board TV',
    caption: "There are no charging ports accessible from the seats. What's worse is that a number of (Thai language) movies were played throughout the journey on the TV at the front of the bus, with the volume barely audible, even if my Thai had been good enough to understand it. For this journey I'd say it's imperetive to have some good noise-cancelling headphones, and a fully-charged device to connect them to.",
  },
]
...
The leg-room is not equal for all seats, and what I found was that the seating on the left (when facing the front of the bus) after the toilet had more leg-room than any other seats on the bus.

While there is a toilet on board, before we departed Korat the staff placed a large plastic box belonging to one of the passenger in front of the toilet door so it was entirely inaccessible. I'm uncertain whether this is always done, or it was just for this journey as there was nowhere else to keep this box, but it essentially meant there was no toilet, so don't drink an excess of water before departing.
