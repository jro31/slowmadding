...
export const meta = {
  ...
  date: '2023-12-24T20:45:00+07:00', // TODO: Update this
...
export const busTimesImages = [
  ...
  },
  {
    ...
    caption: "This is the ticket you're given. The 270 is the price.",
  },
]
...
export const takingTheBusOnBoardImages = [
  ...
  },
  {
    ...
    caption: 'While there is a toilet on board, a plastic blue crate was placed in front of the door making it entirely inaccessible.',
  },
  {
    src: takingTheBusOnBoardTvImage,
    alt: 'On board TV',
    caption: "There are no charging ports accessible from the seats. What's worse is that a number of (Thai language) movies were played throughout the journey on the TV at the front of the bus, with the volume just about audible, but so quiet that I wouldn't have been able to understand it even if my Thai was good enough. For this journey I'd say it's imperetive to make sure your devices are fully-charged, and you have some good noise-cancelling headphones.",
  },
]
...
Luckily for you I recently travelled from Nakhon Ratchasima to Udon by bus, so to save you the trouble, here's everything I learned.
...
You do not need to buy tickets in advance. Perhaps with the exception of holidays, showing up at the a few minutes before the bus leaves is sufficient. I arrived at 8am to catch the 8:30am bus. It was already sat there with passengers on board, so I bought a ticket on got on right away.

A ticket to from Nakhon Ratchasima to Udon costs 270 baht.
...
There is no reserved seating, you just pick a random seat. And while the seats are perfectly comfortable, be aware that there are no charging ports, so make sure your devices are all charged before your leave.

The leg-room for the seats is not the same for all seats, and what I found was that the seating on the left (when facing the front of the bus) after the toilet had more leg-room than any other seats on the bus.

While there is a toilet on the bus, before we departed Korat the staff placed a large plastic box belonging to one of the passenger in front of the door so it was entirely inaccessible. I'm uncertain whether this is always done, or it was just for this journey as there was nowhere else to keep this box, but it essentially meant there was no on board toilet, so don't drink an excess of water before departing.
...
We made initial stops at Phon bus terminal at 10:25am and Ban Phai bus terminal at 10:58, but at both of these stops we were stationary for less than a minute so there was no time to get off to relieve yourself or to get food.

The first stop of note was at <ExternalLink url='https://maps.app.goo.gl/6rk4cTbvMuo9SBEf8'>Khon Kaen bus terminal 3</ExternalLink>, which we arrived at, at 11:38am, three hours and eight minutes after we left Nakhon Ratchasima. It was not intended to be a rest-stop, but I asked the driver (in Thai) if I had a couple of minutes to get off and use the toilet. He agreed, but stressed the 2 minutes. A small number of other passengers also alighted here to use the toilet/buy snacks as well.

I got back on board again as quickly as possible. The bus departed again at 11:45am, so it was a seven minute stop, but there was no head-count or other check that everyone was on board, so make sure you're back. If you're not, they'll be leaving without you.

The first and only actual rest-stop where passengers were invited to get off the bus, came at <ExternalLink url='https://maps.app.goo.gl/fVV2Baw8tbH7MyJ2A'>a petrol station a little outside Khon Kaen</ExternalLink> at 12:33pm. Here there were toilets, a small shop to buy snacks and even a couple of restaurants, although it would have been a rush to eat at them.
...
Getting-off the bus was an influx of people asking if I was going to Nong Khai, but in declining they left you alone. The local tuk-tuk drivers were very respectful and just sat near their tuk-tuks not bothering you, which I appreciated. Getting hassled by tuk-tuk/taxi drivers is one of my pet-peeves.
