...
export const meta = {
  ...
  date: '2024-12-19T18:25:00+07:00', // TODO: Update this
...
That travellers so inexperienced flock to Pattaya goes some way to explain the Pattaya Flying Club, whose innumerable members made up almost exclusively of men, come to Pattaya and commit suicide by jumping off their hotel balconies. Some new recruits can seem a little suspect to me, such as one who joined during my second visit by jumping from a third floor balcony. If I was intent on suicide and had a third floor room, I think at the very least I'd make the effort to walk up the rooftop. Regardless, do come here with your eyes wide open. Many of these suicides are legitimate, with naive men of all ages thinking they've found the perfect girl who's fallen in love with them.
...
I'm not sure who came up with the name for <ExternalLink url='https://maps.app.goo.gl/HX77RZJtjVNPPkND8'>Mike Shopping Mall</ExternalLink>. Probably Mike. Regardles, the stupid name doesn't detract from the fact it's a good place to come if you want to find some cheap clothes somewhere with air conditioning.
...
On the one occasion that I stayed closer to the centre of Pattaya, knowing this I'd typically run the same route, except I'd started running in the centre of Pattaya as soon as the pedestrians and traffic thinned enough that I could.
...
In the south-east end of the park, you come across a rusted children's playground that's now home to a rather aggressive pack of dogs. It feels akin to a scene from The Last of Us. If you make it through the dogs unscathed and go down some steps, you make it to an abandoned car park.

There are a couple of new condo buildings between the car park and the road, and my guess is that they built these condo buildings on wherever the entrance to this car park used to be, and consequently, there's now no way into this park without going all the way around the other side. That kind of ruins it as an option for running if you're staying where I was, because it's a pain to get into.
...
Pattaya attracts tourists from all over the world. There are many Middle-Eastern tourists here, and even more Indian tourists. A consequence of which is that tourist areas of Pattaya are overflowing with Middle-Eastern and Indian restaurants. And when it comes to finding vegan food, that isn't a bad thing.
...
export const veganFoodImages = [
  ...
  },
  {
    ...
    caption: 'If I could only eat one food for the rest of my life, it would be hummus. This one comes from Lebanese House, a restaurant in food court of The Avenue shopping mall in central Pattaya. It costs 75 baht.',
  },
]
...
The menu is honestly a book, it's massive. Perhaps it's dominated slightly by Asian offerings, but there's still plenty of western stuff on there, which I actually recomment a little bit more. I even had two decent pasta dishes here, which is rare. Definitely worth a visiting while in Pattaya.
...
export const gResidenceImages = [
  ...
  },
  {
    ...
    alt: 'G Residence kitchen',
    caption: 'Behind the sofa is the wall that you can see on the right of this photo, so in this apartment, the kitchen and dining area is completely separate.',
  },
]
...
Once you've got yourself back in shape and the memories of the hangovers wear-off, a little voice in that back of your head says _"hey, you know what we should do?"_ At that point you decide to come back, so you can regret it all over again.
