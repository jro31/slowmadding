...
import stateRailwayOfThailandSearchBoxImage from './state-railway-of-thailand/search-box.png'

import ekkamaiBusTerminalHuahinKioskImage from './ekkamai-bus-terminal/huahin-kiosk.jpeg'
import ekkamaiBusTerminalHuahinBusTimesImage from './ekkamai-bus-terminal/huahin-bus-times.jpeg'
...
When I decided to go from Bangkok to Huahin recently, it was a massive ballache figuring-out the quickest/cheapest/safest/best ways to do it because there are so many departure terminals. So here's everything I learned, simplified and all in one place.

I'm not going to cover private transport here. If you plan on hiring a private taxi for the drive, it's going to cost you in the region of 2,000 baht, but that wasn't something I considered. I'm just going to cover buses and train.
...
I'd also been warned that carrying a suitcase as I was, they may charge me more if it didn't comfortably fit in the back of the minivan. Again, this proved untrue as there was a space inside the bus for luggage. There were no extra charges, and the ticket cost 200 baht.

Being a minivan there are obviously no toilets on board, and we made just one very brief (less than 10 minutes) toilet stop a couple of hours into the journey, so don't drink too much before boarding because you'll have to hold it in. There was a small convenience store at this stop if you need any snacks.

As we got towards Huahin, the bus stopped and let locals off at various points, but it's worth adding a warning about a potential scam when got into Huahin.
...
I'm sure he just operates as an unofficial taxi and pays the driver a little kick-back to be able to get on and try and take advantage of any unknowing foreigners.

Once we were moving again, a local on the bus that I'd been chatting to told me that she had no idea why the bus had stopped there as it wasn't a stop. Instead the bus terminates opposite the Market Village Shopping Mall, <ExternalLink url='https://goo.gl/maps/LnJ3VtmtLDod3A2h8'>roughly here</ExternalLink>. It isn't at a bus station or anything, it just drops everyone at the side of the road.

I was very glad that I'd stayed on because this was just a five-minute walk from my hotel, and it also let me see where the buses going in the opposite direction depart from (it's on the other side of the road from where you get dropped-off). Had I listened to this unnecessarily friendly man who I'd never met, I'd have had to pay a taxi fare to get to my hotel and wouldn't have had any idea where to get back to Bangkok from. So be wary.
