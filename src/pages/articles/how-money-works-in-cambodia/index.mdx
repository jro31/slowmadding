...
export const meta = {
  ...
  date: '2023-02-23T15:15:00+07:00', // TODO: Update this
...
If you're coming from abroad and want to bring some local currency with you (not really necessary, as ATMs are everywhere), then you're probably going to be limited to dollars, because it'll be unlikely you can find anywhere exchanging riel. Once you're here, which should you withdraw?

It really depends how long you're going to be here.

If you're here on a short trip and you want use a currency that's going to have some value once you leave the country again, withdraw dollars. If you're going to be in Cambodia for a while, get riel. It's the much safer currency, in that it's accepted no matter the condition and it's dispensed in much smaller denominations. I only withdraw in riel when I'm here, even if it means I have to walk to several ATMs to find one dispensing it alongside dollars.
