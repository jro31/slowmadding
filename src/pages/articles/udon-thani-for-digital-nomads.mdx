...
export const meta = {
  ...
  date: '2026-02-05T19:55:00+07:00', // TODO: Update this
...
TODO: Rewrite this (probably keep it as one text, rather than having sub-sections) - Inlude UD Vegan and Salad Time
...
export const veganFoodImages = [
  ...
  },
  {
    ...
    caption: 'If you get fed-up of Thai food, then your options are somewhat limited. Kera is an Indian restaurant to the north of the city centre. The food is very good and there are plenty of vegan options on the menu, but expect to pay north of 400 baht for a curry with rice, bread and an appetiser. This is the plain naan for 45 baht.',
  },
  {
