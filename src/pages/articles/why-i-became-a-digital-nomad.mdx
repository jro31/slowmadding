...
export const meta = {
  ...
  date: '2023-10-15T17:10:00+03:00', // TODO: Update this
  title: 'Why I Became a Digital Nomad',
  description: 'Is being a digital nomad right for you? There are many different reasons for choosing this lifestyle. These are mine.',
}
...
If I have no daily routine, for example when I arrive somewhere new, then whatever I do on that first day, I'm likely to do on the second day, the third day, and every day after that as well. I'm a creature of habit and find comfort from doing things with regularity.
...
If you look where I go as a digital nomad, it is not North America, it is not Japan or Korea, it is not Australia, and it is not north or western Europe. Why? Why would I go to an expensive country when I can get an equal or better quality of life for a significantly lower cost elsewhere?
...
When you ask people they'll tell you things like _"it's the food and the music,"_ but if that was the case you didn't have to fly all the way to India, you could have just gone to the local curry house.
...
I've been quite sociable in Athens, going out partying a couple of times most weeks. And someone said me the other day _"I'm glad you come out. You're always so happy."_
...
My reasons won't work for you, you have to find your own, but I hope this article can point you in the right direction to know if this lifestyle is right for you.
