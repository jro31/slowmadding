...
export const altEateryImages = [
  ...
  },
  {
    ...
    caption: "This is the alt.Beef UFO burger set. Their burgers come as UFOs. I don't know why more restaurants don't do that, it makes them much more fun. The set includes fries and a small salad for 225 baht.",
  },
  {
  ...
  },
  {
    ...
    caption: "Although alt do pizzas, they're definitely not their forte (see above for better pizza places). You can buy half pizzas, like this 'The saucy motz' pizza half for 200 baht, or a whole pizza will cost you twice that much.",
  },
  {
    src: altEateryAltSignatureBreakfastImage,
    alt: 'alt.Eatery alt.Signature breakfast',
    caption: "Despite being called the 'alt.Signature breakfast', I think this breakfast was a temporary offering, as it never made it onto the main menu. If it is available, it's pretty good and costs 260 baht (or 299 baht with a drink).",
  },
  {
...
alt.Eatery is just a 10-minute walk and the nearest vegan restaurant to the RoomQuest Sukhumvit 36 hotel which, if you look above, I stayed at for a total of six weeks. A consequence of that, was that I came to alt roughly every other day for those six weeks and have eaten almost everything on the menu.
...
I would consider it fast food, because... well it's quite quick, and your food gets brought to you on a tray, and if you want you can order/pay at the counter (although they also have table service), but that doesn't necessarily mean it's all bad. There are salads and other healthy options.

The servings are _quite_ small, so I'd typically come here and have four things, including a drink. That would cost me in the region of 450 baht, and would be a really decent meal. It was especially good after a long run in the Bangkok heat, when I'm at my most hungry and in need of fast calories, because the service is so quick and they have a large selection of donuts and other desserts. There is also a shop on site, but beware that the shop isn't fully vegan; some of the items it sells contain dairy (the restaurant _is_ fully vegan).
