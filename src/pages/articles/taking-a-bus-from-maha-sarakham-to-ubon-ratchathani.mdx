...
export const meta = {
  ...
  date: '2026-02-28T21:25:00+07:00',
  title: 'Taking a Bus from Maha Sarakham to Ubon Ratchathani',
  description: 'Everything you need to know about taking a direct bus from Maha Sarakham to Ubon Ratchathani.',
  keywords: ['Thailand'],
}
...
export const busTerminal2TicketImages = [
  ...
  },
  {
    ...
    caption: 'The times for buses to Ubon Ratchathani are posted on the window, but be warned that on the day I was travelling not all of the buses were running.',
  },
  {
...
We arrived at the <ExternalLink url='https://maps.app.goo.gl/7KnAcqaEMrtysoLV7'>Ubon Ratchathani Bus Terminal</ExternalLink> at 12:20pm after a journey time of just about four hours. It's a way out of the city centre, but there were a tonne of Grab taxis lingering around so getting into the city centre from there was easy.
