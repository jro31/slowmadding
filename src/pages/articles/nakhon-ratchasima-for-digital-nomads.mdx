...
export const cityImages = [
  ...
  },
  {
    ...
    caption: 'Just north of Bung Ta Lua Park (possibly considered part of the same park) is another lake, making this a very pleasant place to come for a walk or a run.',
  },
  {
    src: cityLakeImage,
    alt: 'Lake',
...
export const romyenGardenPlaceImages = [
  ...
  },
  {
    ...
    caption: "Although there's no sink in the kitchen, there is one just outside on the balcony, as well as a chair and a stool, which made it a good place to sit and stop sweating after a run, and to dry your clothes on.",
  },
  {
    src: romyenGardenPlaceViewImage,
    alt: 'Romyen Garden Place view',
    caption: "If you look in the right direction at the right time of day, the view's not so bad.",
  },
]
...
export const vegetarianFoodForHealthImages = [
  ...
  },
  {
    ...
    alt: 'Vegetarian Food For Health ',
    caption: 'Any item they sell can be requested for take-away, but many items are already pre-packaged for taking home, including these spring rolls for 30 baht.',
  },
  {
...
export const terminal21Images = [
  ...
  },
  {
    ...
    alt: 'Terminal 21 ',
    caption: "They don't really speak any English, so it's really just a point-and-hope buffet.",
  },
  {
  ...
  },
  {
    ...
    alt: 'Terminal 21 ',
    caption: 'It also has vegan bread, which is something of a rarity in this part of the world.',
  },
  {
    src: terminal21FoodlandFrozenVeganReadyMealsImage,
    alt: 'Terminal 21 ',
    caption: 'Where it really stands-out though, is that it has a huge selection of vegan frozen meals.',
  },
  {
  ...
  },
  {
    ...
    alt: 'Terminal 21 ',
    caption: "Even though Terminal 21 closes at 9pm everyday, Foodland is open 24 hours per day and after hours you can get in by using this escalator outside the shopping mall. Along with every branch of 7-11 also being open 24/7, there's a surprisingly large selection of frozen vegan food available in the middle of the night in Nakhon Ratchasima.",
  },
]
...
export const laundryImages = [
  {
    ...
    alt: 'Rich laundry',
    caption: "Rich laundry. Although they have self-service machines outside, it's such good value to get a service wash that why waste the time?",
  },
]
...
While this was technically my third ever visit to Korat, the previous two came in 2012 and were simply overnight stops to break-up longer trips I was taking. This was the first time I'd ever stopped here with the intention of getting to know it as a city.

I came from Pattaya, and should probably point-out that I partied a lot in Pattaya, and as a result managed to pick-up a pretty nasty cold/flu/covid bug that I brought with me, limiting the scope of what I could do in Nakhon Ratchasima, including not going out socially once. Still, I spent plenty of time wandering the city and getting to know the feel of it.

It's not quite the most isolated place I've been in Thailand as a foreigner. When I was in Loei earlier this year, I didn't see another foreigner for the entire week, until I was in the airport departure lounge. It's not quite that isolated, but it's only one step above. If you go out for a three hour walk here, you'll perhaps run-into five other foreigners during that time. If you're used to Bangkok, Pattaya, Chiang Mai or any other tourist-heavy places where there are twenty foreigners in your peripheral vision at any one time, Nakhon Ratchasima will be a bit of a shock. Very little here is aimed at foreigners, and very little English is spoken.

I really liked it though. It's a very calm, relaxed place, without much going on. A nice change of pace from Pattaya. Compared to Udon, where I find the local people to be very forward and I'd often have people come and talk to me, here everyone pretty much left me alone.

Wandering down quiet side-roads by myself, as I do a lot, I did find I got some strange looks in the [vein] of _"what's this weird foreigner doing down our street?"_ And I found that in most cases, if I made eye contact with and acknowledged people, rather than returning that acknowledgement, they averted their gaze and walked past me looking uncomfortable.
...
Perhaps because of the poor levels of English, I did find that some people (like fruit vendors, people working in local restaurants etc) even looked a little mortified when I approached them, only to relax and start smiling when I started speaking with them in Thai, even if it was in my very broken Thai. Given the lack of foreigners here, most people, even those in service roles, don't have to speak any English or interact with any foreigners, so it can be a bit of a shock to them when someone like me approaches.

I like that though. I haven't studied any Thai since 2016 and I never got very far. It's only when I'm forced to use it (or when I'm drunk) that I speak any Thai, so I enjoyed that I had to.
...
Because nothing here is aimed at foreigners, there's really not that much 'to do'. You won't find many bars or restaurants calling to you in English. There aren't many massage shops. It's just a nice place to be, where you won't get bothered or harrassed, and you can just exist anonymously.
...
Staying here was a rarity to me, in that I'd call it a proper hotel. It has a concierge, it has room service, it includes snacks in my room that they charge you money for if you eat.
...
It has a very comfortable king-sized bed, with plenty of space in front of it to exercise. There's loads of cupboard space, a nice bathroom, a comfortable armchair that I worked from a lot, as well as a desk and a comfortable chair that make a good workstation (although lacking in nearby plugs).
...
This is the problem with staying somewhere that has room service. They want you to pay for their room service. Well fuck you guys, I brought my own kitchenware so don't have to.
...
With Happy Cow proving unreliable, I had to figure-out vegan food in Nakhon Ratchasima for myself. To my knowledge, there is no late night restaurants serving vegan food here, so the routine I got into was after my morning smoothie I'd make in my blender, I'd get one hot meal per day for lunch. The reason I was so thankful to have a microwave and the fridge in my room, is in the evenings, as well as my evening smoothie, I'd have one or two vegan frozen meals that I'd store in my fridge's ice compartment.
...
Typically, even in Bangkok, you'll never spend more than 20 baht on any of these fruits, so when the street vendor here charged me 30 baht for a pretty small bag of pineapple, I was all fuck you, I'll buy it from Terminal 21 instead. 17 baht, no matter your skin colour.

Down on the ground floor of Terminal 21 when I was here, they had what I assume was a temporary collection of food stands (it might be permanent), and among these was a vendor selling strawberries at very fair prices. Berries usually cost a fortune in Thailand, so I tend to just not eat them, but here they were selling decent-sized punnets of strawberries for 100 baht, which brightened-up my daily smoothies.
...
I don't think I've ever encoutered a frozen section in a supermarket that has more vegan than non-vegan stuff. So to have it in Korat of all places, where it's otherwise a struggle to find vegan food at all, just seemed odd.
...
Given the state of my health in Nakhon Ratchasima, I only made it out for one short, slow run, at <ExternalLink url='https://maps.app.goo.gl/udgpDHDPhjVxAT1d6'>Bung Ta Lua Park</ExternalLink>. That was a shame, because Bung Ta Lua Park was a joy to run in.

As is common-place in Thailand, especially Isaan, if they have a lake, then they just build a running and a cycling track around it. I really wish they did that everywhere, it makes it such a welcoming place to come and exercise. The running track has a 3.2km circumference, is very wide all the way around, and is mostly away from roads so you're breathing clean air. It's also right next to another, smaller lake that has a path (not exactly a running track) around it, that you have to cross a road to get to, but that adds perhaps another kilometre on top.
...
Needless to say, this made communication a lot easier and it was the cheapest laundry I've had done anywhere in Thailand. Usually launderettes with either charge you by weight, or charge you by item. This guy just took my clothes, looked at the bag and said _"120 baht."_ Compare that to 300 baht for a similarly-sized load in Pattaya, and I appreciated this place.

Normally you get told when to come back as well. He instead asked me when I wanted to be able to collect them, and coming in at lunchtime, he offered me 9am the next day.

I had no intention of being up that early, so I said lunchtime would be fine. Back I went the next day and everything was there, and everything was clean.
...
As I mentioned earlier, given the illness I was carrying, I wasn't able to go out socially at all while I was in Nakhon Ratchasima, so I can give you very little insight into how it ranks as a social town. What I will do is detail how I would have gone abut being sociable and... hey, it might work.

Before coming here (and before I got sick) I'd searched for events on Meetup. There are none, so forget about that as a resource. I found one Facebook group; <ExternalLink url='https://www.facebook.com/share/9zsrEmH4EEvahEUf'>Expats in Korat / Nakhon Ratchasima</ExternalLink> that looked fairly active and potentially useful for meeting people. I would be adding a post on there you'd be able to find someone to go for a beer with. It also hosts occasional events.

My first port of call though, was a bar called <ExternalLink url='https://maps.app.goo.gl/CnvUAuH89jmK9PLt5'>Monkey Bar</ExternalLink> that I wandered past several times during my stay. It was the only place that consistently had foreigners in. Even if it was only three or four, no matter what time of day I went past, there was some white person sat in there drinking. So I think your best bet would be to go there and grab a beer, and I'm sure you'd soon find someone to talk to.
