...
import vegetarianFoodForHealthBuffetWithRice4Image from '#/nakhon-ratchasima-for-digital-nomads/vegetarian-food-for-health/buffet-with-rice-4.jpeg'
...
import terminal21RiceWithThreeChoices3Image from '#/nakhon-ratchasima-for-digital-nomads/terminal-21/rice-with-three-choices-3.jpeg'
...
export const vegetarianFoodForHealthImages = [
  {
    src: vegetarianFoodForHealthBuffetWithRice4Image,
...
export const terminal21Images = [
  ...
  {
    src: terminal21RiceWithThreeChoices3Image,
    alt: 'Terminal 21 vegetarian buffet with rice',
