...
For most of my times sitting at the bar here I was the only customer, but that worked quite well because the barmaid on spoke English to a similar level as my Thai, so we both got a chance to practice speaking and she taught me a lot about Korat.
...
export const runningImages = [
  ...
  },
  {
    ...
    caption: "The running track in Bung Ta Lua Park goes the entire way around the lake. The right path is for runners, with faster runners on the right and slower runners on the left (even though I was the only runner when I came here). The path on the left for cyclists is separated by a little verge and a line of trees so you don't have to worry about cyclists straying into your way.",
  },
]
