...
export const meta = {
  ...
  date: '2023-12-03T17:55:00+07:00',
...
export const touristWarningImages = [
  {
    src: '/images/articles/is-airbnb-legal-in-thailand/condolette-pixel-tourist-warning-sign.jpeg',
...
When I used to live in a condo in Sathorn, there were signs everywhere saying that short-term renters weren't welcome and they were there illegally. Each year when I signed a new lease agreement with the landlord, the building's management scrutinized it excessively, almost hoping to find me falling foul of their regulations.
...
A good general rule that I follow, is to avoid Airbnb and use hotel-booking sites like booking.com and Agoda. This is by no means a fool-proof plan as these sites also allow private rentals to be advertised as hotels, so at that point, consider the size of the property and the number of reviews.
...
You can also simply Google the property name. If the results indicate it's a residential building, then it's likely you're looking at a private landlord trying to illegally let their condo. Most hotels will have their own website that makes it clear they're a hotel. Google Maps can also be useful, because if you look at the property on street-view and there's no mention from the outside that it's a hotel, then there's a high chance that it's a property for long-term residents only. Hotels typically want to advertise the fact they're hotels.
