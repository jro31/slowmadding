...
export const meta = {
  ...
  date: '2025-02-22T20:40:00+07:00', // TODO: Update this
...
That's not a bad thing. It's pretty rare that I stay somewhere for only a week, and when I do it's because I'm not expecting to like it. That was my expectation for Buriram. I thought I was going to find myself too isolated, but not at all. As a foreigner here you'll feel a lot more at home that in some bigger cities in Isaan.

Of couse, in a city so small you're limited in what is availabe, and the lack of vegan food here started to grate at me after just a week. That will perhaps preclude me from ever coming back long-term, but with that exception I found it a really lovely, friendly town, where I enjoyed spending my time.

TODO: Add any city images

## Who is Buriram suitable for?

While I found that Buriram had more foriegners than I was expecting (a mix of expats and tourists), it's still not a touristy place. I was expecting zero tourists, and it has more than that. All the expats I encountered here were 60+.
...
export const socialImages = [
  {
    ...
    alt: 'Amsterram',
    caption: "Amsterram is a weed themed bar, if you couldn't tell from the name (Amster, as in Amsterdam, ram, as in Buriram... I assume). That means that when you come here they sell weed alongside alcohol and you'll be offered a joint along with your beer. I politely declined. Weed makes me paranoid, so I don't have it often. The downside is that the vibe in the bar is... it's probably great if you're high, but I just found the stoner music kind of depressing, so I only stayed for one beer.",
  },
]
...
export const runningImages = [
  ...
  },
  {
    ...
    caption: "But even if you're not running, it's a nice place to come for a walk. I walked a lap of the lake on my lunch break on days I was working.",
  },
  {
    ...
    caption: "An alternative to running at Khlong Lalom is to come to the Buriram Rajabhat University running track. It's a standard 400m track in full view of the glorious sunlight. As Thai people descended from vampires, they're all scared of the sun so you'll have the whole thing to yourself.",
  },
  {
...
export const municipalMarketVeganRestaurantImages = [
  {
    ...
    caption: "ร้านอาหารเจ บุรีรัมย์หลังตลาดเทศบาล is a standard point-and-hope 'jay' buffet, although they had a higher than average number of sausage-type things on sticks. This plate costs me 70 baht.",
  },
  {
  ...
  },
  {
    ...
    caption: 'The restaurant is tucked-away in the corner of the municipal market but it quite easy to find with all the usual เจ insignia.',
  },
  {
...
export const laPazImages = [
  {
    ...
    caption: 'There are five items on the vegan venu at La Paz, ranging in price from 69 baht to 119 baht. This is the stir-fried spicy basil and vegan cripy pork with rice, which costs 99 baht.',
  },
  {
  ...
  },
  {
    ...
    caption: 'The reason that La Paz is the easiest place to get vegan food in Buriram is it has a bi-lingual, vegan, picture-menu. Perfect for hangover days.',
  },
  {
  ...
  },
  {
    ...
    caption: "Another one of the 69 baht offerings is the fried Japanese tofu with teriykai sauce. And I would bet everything I have that they didn't get that tofu from Japan.",
  },
  {
...
export const summaryPoints = {
  ...
  neutral: [
    "More expensive than you'd expect (but still very cheap)",
  ],
  negative: [
