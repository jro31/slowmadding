...
export const meta = {
  ...
  date: '2026-03-14T18:40:00+07:00', // TODO: Update this
...
During my second stay in Buriram, I was staying on the very edge of the city, and right outside of my hotel were <ExternalLink url='https://maps.app.goo.gl/cuqVcQUXAuvdBkZp8'>a couple of fields</ExternalLink> with roads going around them. The roads do have vehicles on them, but they're so wide that there's little risk of being hit. Instead you should be more concerned by the hundreds of stray dogs that call these fields home.

Running and stray dogs don't usually mix, and on my first couple of laps I did garner a few barks, but after that they seemed to get used to me. Each lap of these fields is 1.5km, and I ran four laps on six consecutive days when staying here. I didn't have any major issues with the dogs on any of them, so this is another option if you're nearby. You'll also pass several buffalo grazing nearby.
...
export const runningImages = [
  ...
  },
  {
    ...
    alt: 'Running fields',
    caption: "Taken from the room of my hotel, the fields right outside are home to buffalo and loads of stray dogs, but if that doesn't concern you, then the roads are wide enough and quiet enough that you can get some good runs here. One lap is 1.5km.",
  },
]
...
My favourite vegan-friendly restaurant from my first stay in Buriram, La Paz, had closed down by the time I returned, limiting even more the meagre options for vegans in the city.
...
Another place you could try is <ExternalLink url='https://maps.app.goo.gl/7h98Usnz2anxycxu9'>The Salad Lab</ExternalLink>. I went to a restaurant called 'The Salad Lab' during my first stay, which had also closed down by my second. I'll assume it just relocated, although I never made it to this second location, but if it is like the first, then it has a salad bar which was vegan friendly, apart from no vegan friendly proteins.
...
Apart from these places, I typically resort to ordering off Grab when I'm in Buriram - you'll find a couple of restaurants on Grab, such as <ExternalLink url='https://maps.app.goo.gl/LfKtCtLpGpQyL7weA'>Miles Cafe</ExternalLink> and <ExternalLink url='https://maps.app.goo.gl/6gjiEDekagFfF9sz5'>Donburi</ExternalLink>, that have dedicated vegan sections on their Grab menu. Presumably they offer the same if you go to the restaurants in person, although I haven't tried this.

The truth of it is that Buriram is not a very vegan-friendly city, and half of my meals here I ended up just making in my room myself.
...
export const veganFoodImages = [
  ...
  },
  {
    ...
    caption: "The location has since changed, but this is the large bowl at The Salad Lab, which cost me 129 baht. I packed it so full that you can't see the mass of veggies underneath, but there was a lot of goodness there.",
  },
  {
    src: `${imagePath}/vegan-food/miles-cafe-stir-fried-tofu.jpeg`,
    alt: 'Miles Cafe stir-fried tofu with cashew nuts',
    caption: 'Honestly, your best bet for vegan food in Buriram is Grab. I ordered this stir-fried tofu with cashew nuts from Miles Cafe. It cost 149 baht, with the rice being another 20 baht.',
  },
]
...
Yep, no problem. No mention of any additional charges, but why would there be, right? I've already paid for the room for the day and I'd be arriving after check-out time anyway, so it would be completely unreasonable to try to tack-on any charges.

So I arrived at the hotel a couple of hours like I said I would, went up to the front desk, only to be told by the guy working on the front desk _"we usually charge 100 baht per hour for early check-in."_

In short, I told him where to go - I'm not paying extra for a room that I've already paid for. So for the next two hours, with my room at this hotel sat empty and cleaned, I sat on a sofa in reception, studying a bit of Thai, doing a bit of coding, but underneath it, I was absolutely livid.

It was the way he said it as well. "Usually." We usually charge 100 baht. So you mean it's not a hard-and-fast policy, you just feel like being a prick, don't you you fucking prick.
...
export const jiahausImages = [
  {
    ...
    caption: 'The room is really spacious, with lots of natural daylight, and lots of space in front of the TV to exercise by moving the coffee table out of the way. Fuck this place.',
  },
  {
    src: `${imagePath}/accommodation/jiahaus/tv.jpeg`,
    alt: 'Jiahaus Hotel Apartment TV',
    caption: 'You have a fridge and a kettle and a decent TV. Fuck this place.',
  },
  {
    src: `${imagePath}/accommodation/jiahaus/bed.jpeg`,
    alt: 'Jiahaus Hotel Apartment bed',
    caption: "The hotel is located right on the edge of the city so you can watch buffalo grazing outside your room and go running as soon as you step foot outside. It's amazing. Fuck this place.",
  },
  {
    src: `${imagePath}/accommodation/jiahaus/balcony.jpeg`,
    alt: 'Jiahaus Hotel Apartment balcony',
    caption: 'You also have a separate room for storing your things in, and a balcony. Fuck this place.',
  },
  {
