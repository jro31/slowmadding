...
export const meta = {
  ...
  date: '2026-03-15T18:55:00+07:00',
...
export const cityImages = [
  ...
  },
  {
    ...
    caption: "Buriram has lots of workout areas in some very curious places, like here on Sansuk Road. While I'm in favour of giving people a way to exercise, forcing pedestrians to walk in the road might not be the best way of doing it.",
  },
  {
    src: `${imagePath}/city/sunrise.jpeg`,
    alt: 'Sunrise',
    caption: 'I was staying in a fifth floor room with east-facing windows during my first stay, meaning if I woke up in time I saw some beautiful sunrises over Buriram.',
  },
]
...
One of the better options is <ExternalLink url='https://maps.app.goo.gl/zsbJf9cPY5PLZmLRA'>Bee Stop Bar and Grill</ExternalLink>. They have a pool table and a couple of TVs playing sports. Most of the clientele are older foreign men, but that's to be expected anywhere in Isaan.
...
export const jiahausImages = [
  ...
  },
  {
    ...
    caption: "The hotel is located right on the edge of the city so you can watch buffalo grazing outside your room and you can go running as soon as you step foot outside. It would be amazing if they weren't such cunts.",
  },
  {
    src: `${imagePath}/accommodation/jiahaus/balcony.jpeg`,
    alt: 'Jiahaus Hotel Apartment balcony',
    caption: "You also have a separate room for storing your things in, and a balcony. It's not really relevant though.",
  },
  {
    src: `${imagePath}/accommodation/jiahaus/bathroom.jpeg`,
    alt: 'Jiahaus Hotel Apartment bathroom',
    caption: 'The bathroom is lovely too. Jiahaus can fuck off.',
  },
]
...
export const summaryPoints = {
  positive: [
    'Surprisingly high number of foreigner-aimed bars',
    'Studenty vibe',
    'A couple of good options for running',
    'Very safe',
  ],
  neutral: [
    "More expensive than you'd expect for Isaan (but still cheap)",
  ],
  negative: [
