...
export const meta = {
  ...
  date: '2025-03-07T20:40:00+07:00', // TODO: Update this
...
export const cityImages = [
  ...
  },
  {
    ...
    caption: "Buriram has lots of workout areas in some very curious places, like here on Sunsuk Road. While I'm in favour of giving people a way to exercise, forcing pedestrians to walk in the road might not be the best way of doing so.",
  },
  {
    src: `${imagePath}/city/sunrise.jpeg`,
    alt: 'Sunrise',
    caption: 'I was staying in fifth floor room with east-facing windows, meaning if I woke up in time I saw some beautiful sunrises over Buriram.',
  },
]
...
I had a great start here, because despite arriving here just after 10:30am when check-in time was 2pm, they let me check-in right away. That's always very welcome, and I found the staff to be very friendly and personable.

But then once I got up to the room, a couple of things instantly annoyed me. The first was that there were cigarette butts on both the floor of the balcony, and in the sink of the balcony. These weren't hard to spot, and as they got ignored by the housekeepers who came into my room everyday of my stay after that, I can assume they just don't get paid to clean the balcony, because it was disgusting out there. Not just cigarette butts, but the floor out there didn't look like it'd been cleaned in months either. Just ignore the fact that there's a balcony in this room, because it's not really usable.
...
Bzzzt, wrong. The next day they actually did replace the bag with another bin liner, but the day after forgot. Off I went to 7-11. By the end of my stay I was just using this bin without a bag, which made it kind of disgusting. I'm not sure what that game was we were playing. It was a bit weird.
...
export const snowHouseBuriramImages = [
  ...
  },
  {
    ...
    caption: "While the room has a balcony, assume that it doesn't. It was so filthy out there with cigarette butts and other stains on the floor and in the sink that it was basically unusable. Despite this being very obvious, the housekeepers didn't clean it through the duration of my stay.",
  },
  {
