...
export const meta = {
  ...
  date: '2023-08-13T20:00:00+03:00', // TODO: Update this
...
export const edgyVeggyImages = [
  ...
  },
  {
    ...
    caption: "They had this veggy doner on the menu as a summer special. I hope they keep it because I'm definitely going to want another one when I next come back to Sofia. It costs 16 lev.",
  },
  {
...
export const neekoVeganJunkFoodImages = [
  {
    ...
    caption: "Neéko serve a mix of burgers, sandwiches and salads. This is 'The cold Italian' sandwich and costs just 9.49 lev. With French fries costing 3.89 lev, you can both for just 13.38 lev and it's a decent-sized feed.",
  },
  {
...
export const boleroFitburgerImages = [
  {
    ...
    caption: "50% of Bolero's menu is vegan/vegetarian, including seven vegan-friendly burgers. This is the 'Bolero vegan chicken burger' made with a carrot orange bun for 14.90 lev. On the menu the sides were priced separately, but on each time I ate here I bought a burger with a side, and on each occasion the side was included with the burger for free, so there was no extra charge for the fries.",
  },
  {
