...
import citySouthParkPigeonsStatueImage from './city/south-park-pigeons-statue.jpeg'
import cityNationalAssemblyOfBulgariaImage from './city/national-assembly-of-bulgaria.jpeg'
import cityFuckThePoliceImage from './city/fuck-the-police.jpeg'
import citySouthParkTreesImage from './city/south-park-trees.jpeg'
...
import edgyVeggyGrillzillaBurgerImage from './edgy-veggy/grillzilla-burger.jpeg'
import edgyVeggyChickPitchBurritoImage from './edgy-veggy/chick-pitch-burrito.jpeg'
import edgyVeggyGardenClassicBurgerImage from './edgy-veggy/garden-classic-burger.jpeg'
import edgyVeggySweetPotatoFriesImage from './edgy-veggy/sweet-potato-fries.jpeg'
import edgyVeggyVeggyDonerImage from './edgy-veggy/veggy-doner.jpeg'
import edgyVeggyTempehBurritoImage from './edgy-veggy/tempeh-burrito.jpeg'
import edgyVeggyVeggyBurgerImage from './edgy-veggy/veggy-burger.jpeg'

import neekoVeganJunkTheColdItalianImage from './neeko-vegan-junk-food/the-cold-italian.jpeg'
import neekoVeganJunkFoodCheeseburgerImage from './neeko-vegan-junk-food/cheeseburger.jpeg'
import neekoVeganJunkFoodSweetPotatoFriesImage from './neeko-vegan-junk-food/sweet-potato-fries.jpeg'
import neekoVeganJunkFoodDefinitelyNotAChickenBurgerImage from './neeko-vegan-junk-food/definitely-not-a-chicken-burger.jpeg'
import neekoVeganJunkTheMagicMushroomMeltImage from './neeko-vegan-junk-food/the-magic-mushroom-melt.jpeg'

import boleroFitburgerBoleroVeganChickenBurgerImage from './bolero-fitburger/bolero-vegan-chicken-burger.jpeg'
import boleroFitburgerBoleroChorizoVeganBurgerImage from './bolero-fitburger/bolero-chorizo-vegan-burger.jpeg'
import boleroFitburgerBoleroVeganCheeseBurgerImage from './bolero-fitburger/bolero-vegan-cheese-burger.jpeg'

import runningNorthSouthParkStravaImage from './running/north-south-park-strava.jpeg'
import runningSouthParksLoopStravaImage from './running/south-parks-loop-strava.jpeg'
import runningParksLoopStravaImage from './running/parks-loop-strava.jpeg'
import runningNorthSouthParkImage from './running/north-south-park.jpeg'
import runningBorisovaGradinaParkImage from './running/borisova-gradina-park.jpeg'

export const meta = {
  author: 'Jethro Williams',
  date: '2023-08-18T20:00:00+03:00', // TODO: Update this
  title: 'Sofia for Digital Nomads',
  description: "Bulgaria isn't a place that springs to mind when you think of tourism in Europe, and its capital, Sofia, doesn't spring to mind when you think of tourism in Bulgaria. Does that mean that it's not a good place for a digital nomad though?",
}
...
export const neekoVeganJunkFoodImages = [
  {
    ...
    caption: "Neéko serve a mix of burgers, sandwiches and salads. This is 'The cold Italian' sandwich and costs just 9.49 lev. With French fries costing 3.89 lev, you can have both for just 13.38 lev and it's a decent-sized feed.",
  },
  {
...
Optimists. And Nazis, but mostly optimists. Their entire lives are spent disappointed that things didn't live up to their expectations. Unyielding pessimism is the only way to ensure that life is an endless stream of pleasant surprises.
...
Minor confrontations like this, they happen. They're a part of life. I just feel like they happen a bit more in Sofia than in other places in the world. The people in Sofia who're fed-up with life do little to hide their displeasure. There's no attempt to build a cheerful facade.

Don't take that to mean I didn't enjoy Sofia. There are a lot of good things in this city. It's an absolutely gorgeous place architecturally; walking around the old town is a joy in itself, and I found everything to be really, really convenient. I was never more than a short walk to where I wanted to go, whether it be a bar, a vegan restaurant, a gym, a supermaket or a park, to the point that I actually found myself wishing things were a bit more spread-out so I'd have more time outside. And for how fed-up a minority seemed with life, they were never threatening. This is a city feels incredibly safe.

Unfortunately though, negative experiences weigh heavier on the mind than positive ones, and in a regrettable fog of optimism, I was only going to leave Sofia disappointed.
...
<AccommodationAddress name='Neofit Rilski 20' url='https://goo.gl/maps/BzNezHrddTxiU1JR9' />
...
There is just room to comfortably do yoga, which is all the space I really need. Any more is just being greedy, and this room has this much empty space despite also having a dining table with two chairs, an armchair, a desk with an office chair, and a double bed that some nobhead put two mattresses on.
...
It also has a microwave-grill, which I'd never head of until I'd stayed here. It's a microwave and a grill. Together. A microwave-grill. No, I don't know who came up with that either. Probably the same person who invented blackout curtains. I found some minimal use for it by getting some baguettes from the nearby Lidl and toasting them in it, but it definitely wasn't adequate replacement for an oven.
...
The gym was so close that I walked there in my workout clothes. I'd go straight from the gym to Edgy Veggy, which conveniently sold protein shakes you could have with your lunch, and be back at my room in an hour. The location was amazing, and made-up for the frustrations of the room, however slight they were.
...
From a self-catering perspective I found myself limited to meals like hummus pasta and sandwiches, which meant I relied a lot on vegan restaurants. Sofia doesn't have a huge selection of vegan restaurants, but the ones it does have I found to be really good. These were my favourites.
...
It's a fully vegan restaurant, and sells a mix of junk foods like burgers and burritos, with healthier options like avocado toast and salads. I didn't have anything off the menu that I didn't think was really high quality, and being so close to both my gym and my room, I would often come here after a workout for lunch, and they also sell protein shakes.

While the food was always top-notich, the service could suffer occasionally. It's supposed to open at 10am everyday, and one day I came at 10:40am only to be told that they would open _"maybe at 11:30."_ Other days I came earlier than that and they were open, so it's a bit of pot-luck. As is coming here at busy times because, despite being quite a big premesis, they don't have much seating, and if you can't get one of the tables, the bars around the outside aren't so comfortable.
...
The positives definitely outweigh the negatives and the food is always good, but just beware that the service isn't always quite on point.
...
Neéko was still fairly new when I visited Sofia, and is another of its fully-vegan restaurants. As you can probably guess from the name, it's not a place to come for a healthy feed, even though they do offer salads. It's more a place I found myself coming on a hangover, and it definitely helped.
...
One thing I didn't quite understand is that the burgers and the sides are priced separately. Each time I came here I ordered a burger and a side, yet I was only ever charged for the burger. On my first visit I pointed this out to them but they told me it was right. I'm not sure if this is a promotion or whether a side is always free with a burger, but it makes it incredible value when you consider that the cheapest vegan burger, the tofu burger, is only 11.90 lev. It's worth visiting anyway, but if they keep up with that pricing, definitely add it to your list.
...
From that I concluded that Sofia is better for longer, slower runs, for which it is really good. The pavements and roads are quiet enough that you can comfortably run down the street, but with a bit of planning you can do some decent-length runs mostly through parks.
...
</ExternalLink> group. I attended three of these, and they were quite curious events. The "organiser" didn't show up to any of them, and according to the people I met, doesn't ever show up to any of them, yet he continually updates the number of guests he's bringing to each event on the app, which inflates the number of attendees to make it look really popular.
...
With that consideration, despite these Meetups boasting upwards of 25 attendees, the reality was in my experience it would range from four to ten, but they were still fun. I say that from the perspective of someone who's quite happy to sit in a bar alone, so take it with a pinch of salt, but the lesser attended events can be more fun because you get to know a small number of people well instead of meeting thirty people and not remembering anyone's name.

These were the only organised events I attended in Sofia, but one more I encountered was when I was in a bar and a dozen or more miserable looking people not talking to each other wandered in. I chatted to who turned-out to be the organiser, and these people had all just met each other and came into this bar on the first stop of their <ExternalLink url='https://pubcrawlsofia.com/'>Sofia Pub Crawl</ExternalLink> which, as I found out, is a pub crawl that runs every Friday and Saturday and you can attend for 25 lev.

My assumption is that once they'd got comfortable with each other and the alcohol had flowed a bit, then they probably loosened-up and had some fun. They'd signed-up for a pub crawl after all. That's another option, but in truth I didn't find much more here.

If you're a very socially-needy person they Sofia might not be for you.
