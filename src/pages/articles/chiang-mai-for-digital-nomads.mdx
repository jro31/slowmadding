...
export const meta = {
  ...
  date: '2026-01-18T19:35:00+07:00',
...
Another good option is the <ExternalLink url='https://www.facebook.com/groups/349933706518867'>Chiang Mai Language Exchange Party</ExternalLink>, which takes place on the top floor of <ExternalLink url='https://goo.gl/maps/vaFKKwWwzaMFxwuT9'>The Moat House</ExternalLink> every Tuesday.
...
export const veganFoodImages = [
  ...
  },
  {
    ...
    caption: "Healthy Junk offer a 'make your own salad' with, among other options, tofu, tempeh and vegan cheese",
  }
]
...
export const oldyDeGardenImages = [
  ...
  },
  {
    ...
    caption: "Oldy De Garden is actually a very good name for this property, as it's rustic and full of trees. The downside to that is that not much daylight gets in, and the room can feel a bit dingy.",
  },
  {
