...
export const kynosargousApartmentImages = [
  {
    ...
    caption: 'I arrived at the room after dark, which meant I got to take some nice nightime photos before messing everything up. The bedroom is basic but pleasant. Out of shot there is an air conditioner, a cupboard containing a lot of spare towels, and an empty cupboard to keep your things. Unfortunately there is no desk.',
  },
  {
  ...
  },
  {
    ...
    caption: "The coffee table is actually glass. I thought it was plastic until I tried picking it up, but it's pretty damn heavy, and moving it into the hallway every day to have space to exercise was as much of a workout as the workout itself. Once it is out the way and you move the green chair next to the sofa, you have a decent-sized space to exercise in. The TV is quite good, and next to it is one of those little machines that spits-out air freshener every thirty-minutes or so, so it always smelled nice in here, even if being sprayed by air freshener isn't exactly what you want while exercising.",
  },
  {
    src: `${imagePath}/kynosargous-apartment/kitchen.jpeg`,
    alt: 'Kynosargous apartment kitchen',
    caption: "The kitchen's pretty big, although lacks a bit in terms of equipment. There's no microwave, no chopping board, and not even a tea towel. Luckily I carry the latter two of those in my suitcase. You do though have plenty of pans, crockery, and cutlery. Barely in view to the right is the man-sized fridge/freezer.",
  },
  {
  ...
  },
  {
    ...
    caption: "The shower looks very fancy, but whoever designed the thing that hold the shower head needs their own head tested. The angle that it's sitting at right there is the only angle that it sits at, so you have to hold the shower.",
  },
  {
  ...
  },
  {
    ...
    caption: "The balcony is small and the view isn't going to give you many great photos, but it's very nice to sit out here with a cup of tea in the mornings.",
  },
  {
