...
export const meta = {
  ...
  date: '2023-10-26T13:05:00+07:00', // TODO: Update this
...
export const cityImages = [
  ...
  },
  {
    ...
    caption: 'The view from Apollon Tower at night.',
  },
  {
    src: cityStreetImage,
    alt: 'Athens street',
...
export const breadFactoryImages = [
  ...
  },
  {
    ...
    caption: "I don't remember what this one was called, but it was basically sunflower seeds held together by a load of sticky goodness.",
  },
  {
    src: breadFactoryVeganBurgerImage,
    alt: 'Bread Factory vegan burger',
    caption: "It's not just sweets either, they also sell vegan hot food, including this vegan burger for €2.98",
  },
  {
...
export const runningImages = [
  ...
  },
  {
    ...
    caption: 'The tram goes from the Neos Kosmos all the way to the sea, so if you want a decent run without having to navigate, run along the pavement while following the tram tracks.',
  },
  {
...
I'm typically a regular at my local vegan restaurants when I go somewhere, but a combination of the cost of accommodation in Athens, the quality of the kitchens that I had, and the distance of vegan restaurants from my first room, meant that here I made the vast majority of my meals for myself, like a peasant.

That isn't to say that Athens is a hard city to be vegan in if you don't have a kitchen, it's really not. There are vegan, or otherwise vegan-friendly restaurants dotted all over the central parts of the city, so explore the area locally to where you're staying, and you're almost certain to find something. When you venture farther from the city centre they become a little more sparse, but it's certainly not a hard city in which to be vegan.
...
For example, they have three kinds of burgers, a club sandwich made from seitan, kebab slices made from lentils and chickpeas and perhaps my favourite was the zen palette plate which included tempeh, tofu and seitan. A great post-workout meal I'm sure.

The most expensive dishes on the menu are €11.50, but they have many that are cheaper. They also have free water readily available and don't pressure you at all to buy a drink, so the menu price of the food is what you'll end up paying.
...
Because of how readily-available vegan food is in Athens, I wouldn't really recommend travelling to find it, but if there is one place I ate that's worth travelling for, it's this one.
...
In a city with plentiful vegan restaurants, Bread Factory might seem like a very strange choice to include in the best places for vegans in Athens, but the reason I include it is I found it incredibly convenient, stocking the kinds of items that were hard to find elsewhere.

To start with the convenience, it's open 24 hours per day so no matter what time of night you get peckish, you can come here and find something. In that sense, it's great for drunk food, although it often astounded me how many non-drunk people would come here to sit quietly with a hot drink in the dead of night. Beyond that, everything in the shop is clearly labelled, with all vegan items having a 'vegan' icon attached to them, so you can really easily identify what you can eat here, again useful when drunk.

And while the name may imply that it's an industrial bakery, it offers much more than that. I like to make my daily smoothies with seeds, and they sell some here, very reasonably-priced, including chia seeds and flax seeds, which aren't too easy to find around Athens. It has vegan ice cream, and plenty of vegan snacky food that you can put on the table for every time you feel peckish. Things like vegan cookies and sweets also aren't so available elsewhere. They also sell hot food, including vegan burgers for just €2.98, which is where is becomes great for you post-drinking stumble home.

I'll stress that it's not a place that you should travel far to visit, there's little here to blow your mind. But if you're staying nearby, it might surprise you how many useful items that are hard to find elsewhere are stocked here, are clearly labelled as vegan, and are available 24 hours per day.

<ImageGallery images={breadFactoryImages} />

### Supermarkets

Given how vegan-friendly the restaurant-scene is in Athens, supermarkets leave a little to be desired. For some reason, every supermarket, even smaller ones, seem to have vegan cheese. Beyond that, most don't have any dedicated vegan sections, just a few unintentionally vegan items dotted around the store.

For example, I did the majority of my shopping at Lidl, where you can buy wholewheat pasta, hummus, vegan cheese and corn, to make my world famous hummus pasta. Or you can buy wholewheat tortilla wraps, hummus, salad, corn, kidney beans, olives and vegan cheese for my world famous tortilla wraps. Many of the bread items in the supermarkets are vegan, and you'll find some vegan pasta sauces, other things like gnocchi that can be turned-into a meal, some muesli being vegan with many plant-based milks, and even the occasional vegan instant meal (Lidl sells a pre-made vegan moussaka).

Combine that with the usual fruits and vegetables and you won't go hungry shopping in the supermarkets in Athens, but compared to places I've been previously (I'm thinking particularly of Bucharest), the supermarkets in Athens aren't overly vegan-friendly. The vegan food they have is mostly by accident.
