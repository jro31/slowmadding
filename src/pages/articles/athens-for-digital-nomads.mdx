...
export const meta = {
  ...
  date: '2024-10-30T19:00:00+02:00',
...
export const cityImages = [
  ...
  },
  {
    ...
    caption: "It also helps to show how close Athens is to the sea. Roughly an hour's walk from here and you can be at the water's edge. I've never actually sat on the beach in Athens, but I do like the idea of it.",
  },
  {
  ...
  },
  {
    ...
    caption: "Night or day it's a beautiful place.",
  },
  {
    src: `${imagePath}/city/street.jpeg`,
    alt: 'Athens street',
    caption: "And there's something very Athenian about the streets.",
  },
]
...
export const socialImages = [
  ...
  },
  {
    ...
    caption: "This is the Blabla Language Exchange at High Bar in late August '23. Being at a rooftop bar in August when the weather is beautiful - what beats it?",
  },
  {
...
export const neaSmyrniParkImages = [
  {
    ...
    alt: 'Nea Smyrni Park',
    caption: "The north-east edge of Nea Smyrni Park, next to the workout area, is the flattest part of the loop. It's not that flat.",
  },
]
...
<ExternalLink url='https://maps.app.goo.gl/Ae7WcMURk3o5demh7'>Grigoris Lamprakis Stadium</ExternalLink> sits in between Koukaki and Kallithea. It's a somewhat rickety old stadium with a football pitch in the middle and a running track around the outside. Parts of it have been cut-into the surrounding rock, so in a way it's kind of beautiful.
...
<ExternalLink url='https://maps.app.goo.gl/qkZFRJkh4vtVQA4n9'>Stavros Niarchos Park</ExternalLink> is down by the water's edge, so is going to be out of reach for people staying anywhere near the centre of the city. If you can easily get here, it's perhaps the best option for running in Athens.

Looking at a north-facing map, you'll see the park is shaped somewhat like a diamond. In the northern corner of this diamond is the <ExternalLink url='https://maps.app.goo.gl/fXjopxLdJ1ffQuR99'>Kallithea Municipal Running Track</ExternalLink>. That's a very extravagant name for a rather uninspiring running track.
...
export const stavrosNiarchosParkImages = [
  ...
  },
  {
    ...
    caption: "Take the word 'park' with a pinch of salt. It's more a complex than it is a park, but that means there are lots of stairs if you want to add some stair running into your workout. The canal has a few people wandering around it, but not so many that you can't do a slow run.",
  },
  {
    src: `${imagePath}/running/stavros-niarchos-park/cycling-track.jpeg`,
    alt: 'Stavros Niarchos Park cycling track',
    caption: 'This is the cycling track. Feel free to annoy the cyclists by running on it.',
  },
]
...
The last place I've run in Athens is <ExternalLink url='https://maps.app.goo.gl/U1Dofn9awMivcpEb8'>The National Garden</ExternalLink>. I came here when running with someone else, and although it's a fairly pleasant place to walk, it's too small to run any distance and there are a lot of people wandering around.
...
export const groceriesImages = [
  ...
  },
  {
    ...
    caption: "Come my second stay I was being a bit more health-conscious thankfully, and came-up with things like this tofu and vegetable stir-fry instead. It's just tofu stir-fried in a little olive oil, add in some chunky veg, and mix in some pre-made Uncle Ben's sauce because that's what real chefs do. The room I was staying in didn't have a collinder or any way of draining rice, so I instead bought those bags on Uncle Ben's rice for lazy people, where you put the bag in boiling water for ten minutes then fish it out with a fork. When I moved to my next room I did have a collinder, but I still bought these bags of rice because they'd made me lazy. All ingredients were bought at Lidl.",
  },
  {
    src: `${imagePath}/vegan-food/groceries/burrito.jpeg`,
    alt: 'Vegan burrito',
    caption: "This is the next gen of the stir-fry for when I got bored of making the stir-fry but couldn't be arsed to think of anything new to cook. It's basically the same thing except instead of Uncle Ben's sauce I added some kidney beans and put it in a wholewheat wrap and called it a burrito. The wrap is from Lidl, with the beans coming from a branch of BAZAAR Supermarket. Lidl are surprisingly bad at selling pulses here.",
  },
  {
    src: `${imagePath}/vegan-food/groceries/baked-potato.jpeg`,
    alt: 'Baked potato with beans',
    caption: "The ultimate lazy man's meal, for when you want to feel like you're cooking but can't be arsed. Potato. Put it in the oven on high for an hour. Pour on baked beans.",
  },
  {
...
I've always struggled to find rooms that satisfy the criteria I look for, to the point that on multiple occasions I've started looking in other cities and countries. Somehow though, as if by magic (or perhaps just people cancelling), a room that fits what I'm looking for always seems to pop-up.
...
export const neosKosmosApartmentStays = [
  {
    dates: {
      checkIn: '2023-08-10',
      checkOut: '2023-09-21',
...
<AccommodationTable stays={neosKosmosApartmentStays} />
...
export const koukakiApartmentStays = [
  {
    dates: {
      checkIn: '2023-09-21',
      checkOut: '2023-10-26',
...
<AccommodationTable stays={koukakiApartmentStays} />
...
export const kynosargousApartmentStays = [
  {
    dates: {
      checkIn: '2024-08-15',
      checkOut: '2024-09-26',
...
<AccommodationTable stays={kynosargousApartmentStays} />
...
export const kallitheaApartmentStays = [
  {
    dates: {
      checkIn: '2024-09-26',
      checkOut: '2024-10-31',
...
<AccommodationTable stays={kallitheaApartmentStays} />
...
export const kallitheaApartmentImages = [
  ...
  },
  {
    ...
    caption: "The kitchen is one of the best-equipped and nicest to cook in that I've had in an Airbnb. Lots of surface area, cupboards filled with various bits of equipment, and the biggest roll of paper towel I've ever seen.",
  },
  {
  ...
  },
  {
    ...
    caption: "You can access the courtyard from the living room or the bedroom, but from the bedroom you have a fenced-off little area with a table and chairs. It's pleasant to sit here, until someone from one of the other rooms sits outside and starts smoking.",
  },
  {
  ...
  },
  {
    ...
    caption: "This is the front entrance to the building. It's on a main road, but as the apartment is around the back, noise is a non-issue. If you can see the sign that says Ancestree Relaxation, the building entrance is directly below that, behind the tree. You may also be able to make-out the bus stop hence why you'll rarely leave the building and there not be people sitting on the steps waiting for a bus.",
  },
]
...
export const summaryPoints = {
  positive: [
    ...
    'Very walkable',
    'Consistently high quality accommodation',
    'Tap water tastes really nice',
  ],
  neutral: [
...
Maybe it's just me, I don't know. I've met my share of locals and foreigners who really don't like Athens. So maybe you'll come here and curse me out for recommending it. But I come to Athens and I'm happy, and that's as simple as I can say it.
