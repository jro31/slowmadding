...
export const imagePath = '/images/articles/what-to-pack-as-a-digital-nomad'

export const bagsImages = [
  {
    src: `${imagePath}/bags/rucksack-and-suitcase.jpeg`,
...
export const sustenanceImages = [
  {
    src: `${imagePath}/sustenance/me-and-knifey.jpeg`,
    alt: 'Me and Knifey',
...
export const securityImages = [
  {
    src: `${imagePath}/security/pacsafe-wrapsafe-adjustable-cable-lock.jpeg`,
...
export const miscellaneousImages = [
  {
    src: `${imagePath}/miscellaneous/joey.jpeg`,
    alt: 'Joey',
