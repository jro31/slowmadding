...
export const meta = {
  ...
  date: '2025-04-04T17:55:00+07:00',
  title: 'Taking a Bus from Pattaya to Huahin',
  description: 'Travelling from Pattaya to Huahin? These are your options.',
...
To get to Suvarnabhumi Airport from Pattaya, the best option is Roong Reuang Coach, which departs from <ExternalLink url='https://maps.app.goo.gl/WNghE4rDA8DSXJUY8'>Jomtien Bus Station</ExternalLink> (more on this below). There are also buses to Suvarnabhumi Airport from the North Pattaya Bus Terminal.
...
export const jomtienBusStationImages = [
  ...
  },
  {
    ...
    caption: "The staff speak basic English, but as there's only one route and you can point at the time you want to leave on one of the signs, there's not really that much to communicate. Tickets to Suvarnabhumi Airport cost 143 baht, and can be paid for in cash only. They don't even let you scan-to-pay (I tried).",
  },
]
...
I arrived at Jomtien Bus Station at 6:37am. There were already two buses to Suvarnabhumi Airport there with passengers on, but many empty seats. Note that in the ticket office, there is a sign that says you'll be charged extra for any baggage, and when I handed my bag to the driver he asked me how much it weighed. I replied _"17kg"_ in a _'I've been up since 5:20am so don't be a fucking prick you fucking prick'_ voice, and that was good enough. I got waved onto the bus without having to pay extra.
...
export const jomtienToSuvarnabhumiImages = [
  {
    ...
    caption: "Buses depart every hour on the hour from 6am to 10pm. Travel time is listed as two hours, but for me it was less than this. On the sign at the right of the picture is the list of baggage surcharges. Unfortunately I didn't get a better picture than this, but for a normal-sized bag it was an extra 20 baht.",
  },
  {
...
As if I didn't understand, some smug prick behind me in the queue felt the need to reiterate _"you need to book online because these buses sell-out."_

Yeah, thanks mate.

For a moment I thought about waiting until the 2:30pm bus, but then thought fuck-it, I didn't get up at 5:20am this morning to arrive in Huahin at sundown. I'll figure-out some other way. So I wandered down to the taxis and jumped-in one, telling the driver to take me to Ekkamai Bus Terminal.
...
export const suvarnabhumiAirportImages = [
  ...
  },
  {
    ...
    caption: "Buses depart to Huahin at 7:30am, 8:30am, 9:30am, 10:30am, 12:30pm, 2:30pm, 4pm, 5pm and 6:30pm. The tape across the Pattaya to Huahin time shows that it was quite recent that they changed times and removed the early morning bus. Either that or they're just too lazy to print out another timetable.",
  },
]
...
There was only one stop of note - a toilet stop at the <ExternalLink url='https://maps.app.goo.gl/6R3w7WAX7qLqKeGT8'>Mae Klong rest area</ExternalLink> at 11:52am. We left again at 11:57am, so there wasn't even time to get food or take a shit.
