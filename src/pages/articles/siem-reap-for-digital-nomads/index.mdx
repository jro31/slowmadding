...
Half of the restaurants in Siem Reap seem to contribute charitably to the local area somehow. I'm not saying that to diminish the value of their work, rather in other cities, it can be a big reason I go to eat somewhere. Seeing as it's true for almost every restaurant here, it doesn't hold the same value, however New Leaf Eatery is one of those places that tries to be ethical, envioronmentally friendly, and that donates profits to local education.
