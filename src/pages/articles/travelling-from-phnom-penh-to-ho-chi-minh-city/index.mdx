...
export const meta = {
  ...
  description: 'Everything you need to know if you want to travel from Phnom Penh to Ho Chi Minh City (Saigon).',
}
...
I'd assumed that the logic of moving the bus terminal to outside the city, was that it saves the bus driving through the city centre. When it does it anyway, then I'm not really sure what the point is, but that's the way it is.
