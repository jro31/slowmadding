...
export const meta = {
  ...
  date: '2023-05-19T17:30:00+07:00', // TODO: Update this
  title: 'Loei for Digital Nomads',
  description: "Loei is a small, non-touristy town in Isaan, far from the typical Farang trail in Thailand. Does that mean you should avoid it? Or is it actually a hidden gem and a secret digital nomad paradise?",
}
...
I need it for work obviously, being a software engineer and having to do video calls, not to mention that coding is also my main free-time activity. One of the first things I do when I stay somewhere is plug my Apple TV into the room's TV, which I use for Netflix in order to relax at the end of the day, and for Peloton in order to do yoga and other exercise. So if you put me in the room with the shitty wifi signal, you suddenly inhibit my ability to work, to code, to exercise and to relax.
...
I found that there were a lot of unnecessary items and surfaces in the room. According to the booking.com listing it's a 40m² room. That seems an exaggeration, but even so, there was so much unnecessary stuff in the room that I couldn't comfortably do yoga.
...
All of this took some getting used to. I learned to tether my laptop to my 5G connection if I needed a reliable connection for anything. Whenever I went out I'd make sure to make a lot of noise and close the metal gate to the grounds really loudly so that the maid would see that I'd gone out, would make-up the room when I was gone, and then I wouldn't have to worry about anyone coming in for the rest of the day. I learned to work around the annoying layout, and I got used to the bugs as well because... well eventually you just need to sleep.
...
Beyond Happy Cow, usually I can find more vegan food by wandering the streets and looking out for 'jay' signs at street vendors, or by looking on delivery apps like FoodPanda and Grab and searching for vegan food on there.
...
The first time I came I was greeted by a middle-aged man walking around with no shirt on. That might be enough to put people off. Seeing as this is one of the only two vegan restaurants in town, I didn't have that luxury, but it's actually a really good place.
...
On my bus into Loei from Udon Thani, I noticed a separated cycle path that runs south alongside the 201 highway from roughly adjacent to the Loei Bus Terminal. I didn't see a single bicycle on it though; just the occasional stray motorcycle (despite the 'No motorcycle' signs).
