...
Taiwan's capital Taipei has a lot to offer any digital nomads that choose to venture here. It's a modern city with an exciting backdrop of mountains and hiking trails. It offers an extensive and affordable network of public transportation, and with the exception of Ximen is clean, spacious and offers a good selection of food.

It initially appealed to me as a destination because I'd been told it was just like Japan, but cheaper, which is great because I can't afford Japan. Now that I've been here, I can confirm that it's just like how I imagine Japan to be. Coming here from South-East Asia it felt like I took a giant step up the social ladder. Everything is cleaner, everything is quieter, the people are more patient and road laws are actually obeyed. I got to know some people that live in Japan who said the exact opposite, and found it a step-down from Japan, so it's perhaps somewhere in the middle. It's the most developed and civilised place that I've been in Asia though.

Perhaps on the cusp of an explosion in visitors, it doesn't yet feel like it's really been 'discovered' as a tourism destination. I'm hesitant to write this article because I don't want to contribute to any increase in tourism. Luckily no one reads this shite so I should be alright.

I think the best indicator of how much I loved it, was that I initially came here having booked a four-week stay. I ended up staying for twelve, leaving only as my visa waiver expired. Read on to find out why.
...
export const cityImages = [
  ...
  },
  {
    ...
    caption: "There is a changing of the guard ceremony at the Chiang Kai-shek Memorial Hall where some soldiers really, really slowly swap places with each other while hundreds of tourists film them. Not sure what that was all about, but it's a nice view if you're here for sunset.",
  },
  {
  ...
  },
  {
    ...
    alt: 'Heping Island',
    caption: 'Nearby to there is Heping Island.',
  },
  {
...
export const suitabilityImages = [
  ...
  },
  {
    ...
    alt: 'Bitoujiao Trail',
    caption: 'This is the Bitoujiao Trail - an easy but at times breathtaking trail in north-east Taiwan.',
  },
  {
    src: `${imagePath}/suitability/tingtao-cafe.jpeg`,
    alt: 'Tingtao Cafe cat',
    caption: "Cats are everywhere in Taiwan. Top of a mountain, middle of the night, doesn't matter. \"Meow... meow.\" Hiking along the Bitoujiao Trail you'll get to the Tingtao Cafe, complete with cat.",
    url: 'https://maps.app.goo.gl/CZ2iXdsnJKJNmSvD8',
  },
  {
    src: `${imagePath}/suitability/heping-island-geopark.jpeg`,
    alt: 'Heping Island Geopark pagoda',
    caption: 'Heping Island Geopark is somewhat ruined by the volume of tourists, but still offers some good experiences.',
    url: 'https://maps.app.goo.gl/cKRAWMLB3LUereJe7',
  },
  {
  ...
  },
  {
    ...
    caption: "Qingtiangang Grassland is what the Calm Lands in Final Fantasy X are based on. That's a lie, but it did remind me of it.",
  },
  {
  ...
  },
  {
    ...
    url: 'https://maps.app.goo.gl/Gnqv32FXh7uT8ro2A',
  },
  {
...
Taipei is such an easy city to get around. Not only does it have an extensive and affordable MRT network that can be easily navigated by English speakers, but YouBike, Taipei's bike sharing scheme, is the best I've ever used. Between those two, everywhere in Taipei's accessible.
...
YouBike (also Ubike) is my favourite thing about Taipei, and that's a pretty big statement, because I love most things here. It's Taipei's bike sharing scheme, but it's done better here than anywhere else I've been.
...
In order to encourage people to ditch their cars in favour of cycling, as of March '24 rentals of less than 30 minutes are free, and most of the time you get a YouBike, it's going to be for less than 30 minutes. I got a YouBike multiple times daily during my three months in Taipei; that's how I got around, and I barely paid for any of them. Even if you do rent the bike for longer, the cost is negligible. It's an incredibly cheap way to get around.

Giant, the bicycle manufacturer, are both the biggest bicycle manufacturer in the world, and Taiwanese. I haven't verified either of those statements, but they were proudly said to me by multiple people during my stay. All I know about them is when I lived in London and cycled everyday, they were way out of my price range.
...
And I would describe Taipei as the most cycle-friendly city I've ever been to, outside of Europe. Many pavements include cycle lanes, and cyclists are allowed (and expected) to use the pavements throughout the city. While you can cycle in the road if you choose, it will never be necessary within the city centre.

A perhaps intentional side-effect of this, is by making every pavement in Taipei cycle-friendly, it also makes Taipei the most wheelchair-friendly place I've ever been. If you don't have legs you'll love it here.
...
The MRT is the easiest way to get around Taipei. Every sign and every map is translated to English, and on the rare occasions I had to deal with a human person (like when buying my EasyCard) they spoke English.

Fares range from NT$20 to NT$65 (not including to/from the airport, which costs NT$160), with trains going walking distance to basically anywhere you're going to want to go in Taipei. The trains are fairly modern, and while you can't always guarantee you're going to get a seat, I never experienced them getting so busy they were uncomfortable to travel on, even if travelling with luggage.
...
export const veganFoodImages = [
  ...
  },
  {
    ...
    url: 'https://maps.app.goo.gl/G7DthPaX8nXe67Z76',
  },
]
...
It's more expensive than your typical local restaurant, the menu is translated into English, and the counter staff have very good English. Despite that, the vast majority of customers that come here are locals.
...
I tore my right calf muscle midway through my stay in Taipei, and it's with regret that I only ran at National Taiwan University as part of my recovery, because they have a really nice running track. Much nice than the National Taipei University of Technology Sports Ground (above). It's blue, and I don't know what it is about blue, but running on a blue track makes you want to run faster. I had to hold myself back from breaking-into a sprint and reinjuring my calf.
...
While there are some events centred around alcohol, they are in the minority with hiking and outdoor activity groups, fitness groups, and language exchange groups being much more popular. I attended the weekly event of the <ExternalLink url='https://www.meetup.com/language-friendship/'>Language Friendship</ExternalLink> consistently while in Taipei. Each event attracted up to sixty people, with some regular attendees and some new people each week, so was a really great resource for me to get to know people. If that doesn't look your kind of thing, there are many other groups to try.

The only real downside I found, is that almost every group had its events on the weekend (usually Saturday), so on weekdays there wouldn't be very much going on, yet suddenly on the weekends there would be ten events I wanted to attend, yet I only had the time for one or two.
...
export const sociableImages = [
  {
    ...
    url: 'https://maps.app.goo.gl/hRVdkoEV4yzL7dxH6',
  },
  {
  ...
  },
  {
    ...
    url: 'https://maps.app.goo.gl/YA6Ca1gmBKtnUQUi8',
  },
  {
  ...
  },
  {
    ...
    caption: 'This is Old Caoling Tunnel - a former railway tunnel, now used primarily by cyclists.',
    url: 'https://maps.app.goo.gl/ai6sJb2G3D1UYGJQ6',
  },
]
...
TODO: Add note/link about legality of Airbnb?
...
Staying here was a last minute decision when I decided to extend my stay in Taipei. Considering that it could have been a lot worse.

Although I booked it on Airbnb, I would consider it more of a hotel room than an apartment. The room got fully cleaned once during my stay but staff come through the floor every day, so if you want fresh towels, for example, leave your dirty towels outside the room and they'll be replaced. I also don't think any residents, at least on my floor, are long-term. In both of the rooms adjacent to mine, the tenants rotated a lot. I know that because the walls are frustratingly thin. That's a biggest flaw of this room.

It's on a main road, and there is some very impressive sound-proofing to ensure the sounds from the road below don't disturb you. Unfortunately they spent all their efforts sound-proofing from the road, and made no efforts to sound-proof from other rooms so you can have a nice bedtime story if the people in the next room are talking into the night.
...
It's below the TV. I thought about trying to move it, but there wasn't really an alternative place. The reason it's so annoying is that if, like me, you like to use a room's TV for exercise then you're going to struggle. Once you're lying on the floor you can't see the TV because someone put a fridge in the way. I had to do workouts on my phone.

There are no washing facilities in the room, but there's a washer and drying shared by the rooms on the sixth floor. The washer is free with detergent being provided, the dryer costs NT$50 (you need 5x NT$10 coins). As there is a clothes horse in the room, unless you're in a rush, you're not going to need the drying.
...
Considering staying here was a last minute decision it could have been far worse - in many ways it's a really nice room. Just be aware that the sanctity of your stay will be determined by the bedtime and the thoughtfulness of the people in the adjacent rooms. If you're unlucky enough to have noisy neighbours that stay up late each night, you're probably not going to have a good time.
