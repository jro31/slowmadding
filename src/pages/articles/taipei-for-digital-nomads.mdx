...
export const meta = {
  ...
  date: '2024-07-10T16:25:00+02:00', // TODO: Update this
...
Taiwan's capital Taipei has a lot to offer any digital nomad that chooses to venture here. It's a modern city with an exciting backdrop of mountains and hiking trails. It offers an extensive and affordable network of public transportation, and with the exception of Ximen is clean, spacious and offers a good selection of food.
...
Perhaps on the cusp of an explosion in visitors, it doesn't yet feel like it's really been 'discovered' as a tourism destination. I'm hesitant to write this article because and contribute to any increase in tourism. Luckily no one reads this shite though so I should be alright.
...
export const cityImages = [
  {
    ...
    alt: 'Lingxiao Palace',
    caption: 'Lingxiao Palace is on a hillside and offers amazing views of the city. I rather liked this dragon though.',
  },
  {
  ...
  },
  {
    ...
    caption: "Taipei is surrounded by mountains, like Jiantan Mountain, that give amazing views down of the city - even when it's raining.",
  },
  {
    src: `${imagePath}/city/zhinan-temple.jpeg`,
    alt: 'Zhinan Temple',
    caption: 'This is Zhinan Temple, a short walk from Lingxiao Palace.',
  },
  {
...
Airlines get fined when they bring passengers who're denied entry, so if you're travelling without an outbound ticket you're much more likely to have issues boarding the plane than you are at immigration.
...
As I said this, it was fully of the expectation that he was going to tell me I needed to buy one before checking-in. Instead, he thought for a second before asking _"do you want a seat with extra legroom?"_

So that's how seriously they take the outbound travel requirement. I didn't have any and I got upgraded for free. When I went through immigration in Taiwan I got no questions at all, about outbound travel or anything else.
...
YouBike (also Ubike) is my favourite thing about Taipei, and that's a pretty big statement seeing as I love most things here. It's Taipei's bike sharing scheme, but it's done better here than anywhere else I've been.

YouBike docks are everywhere. You can't walk five minutes without running into one, so no matter where you want to start or end your journey, you're going to be able to find a place to collect and return a YouBike. You can rent a bike with an EasyCard. You have to register, but once you have, getting a bike is so easy. Press a button, scan your card, and you're away. To return it, place the bike into the dock, scan your card again, and that's it.
...
It's an issue so complicated to new arrivals in Taipei, that if you look on Google many peope have written entire articles about how to throw away your rubbish (like <ExternalLink url='https://corissajoy.com/garbage-disposal-taiwan/'>this one</ExternalLink>).
...
I'll add that I'm not against the concept of women testing the waters to see if they're suitable to for motherhood; that's just being responsible, and perhaps a reason that crime is so low here is that so few kids are born to unfit parents. If you want something to baby though, why not choose something that can't walk, like a snake or a grapefruit? Leave the dogs out of it, they deserve to be free.
...
It's more expensive than your typical local restaurant, the menu is translated into English, and the counter staff speak very good English. Despite that, the vast majority of customers that come here are locals.

A menu update mid-way through my stay precluded a slight price increase, but even then I found it fair. Typically I'd get a curry (starting at NT$200 after the menu change) and a bowl of dumplings (NT$105 for six). That's a good-sized and healthy feed for just over NT$300.
...
export const yuliYourHomeImages = [
  ...
  },
  {
    ...
    caption: "Whether getting a curry or a bibimap, I'd always got some dumplings on the side. Assorted boiled dumplings are NT$105 for six.",
  },
  {
...
export const burgerSuVeggieImages = [
  ...
  },
  {
    ...
    caption: 'The most expensive of the burger patties they offer are Beyond Meat, which seems to be overpriced the world over. Here I got it with vegan tuna, which I highly recommend. The burger alone is NT$289, or another of the combo options includes either fries or sweet potato fries, as I got here, with a black tea for an extra NT$79.',
  },
  {
  ...
  },
  {
    ...
    caption: "I know what you're thinking - that hot dog's sitting more on the bun than it is in it, so is going to be really hard to eat so it'd make much more sense to use a knife and fork than to eat it like a hot dog. Yes, I thought the same but tried to eat it like a hot dog anyway, spilt the saugage on myself getting mustard all over my t-shirt and shorts, and even in my watch strap. It was impressive how much of a mess I made, harking back to my days as a toddler. Once I'd composed myself, I rebuilt my hot dog and ate it with a knife and fork. If you too want to remember how it feels to be young, the vegan pickles hot dog costs NT$159.",
  },
  {
...
export const lovingHutImages = [
  {
    ...
    caption: 'This is the lemon shredded chickenless - basically just vegan chicken on lettuce with a load of hot things on top. I loved it. It costs NT$300.',
  },
  {
...
For my first run here I did a steady 5k, which is 25 laps and is just depressing, going around and around and around and around. Luckily I was in terrible shape and in an attempt to recity that started doing guided HIIT runs and interval runs instead, and for this kind of run having a track, even just a 200m one, is perfect.

I don't think at any point I had to share the track with more than four other people, no matter what time of day I came. Taipei is already incredibly safe, and being a small track on a university campus, you can bring a bag and leave it unattatended with little worry it'll get nicked, and there are toilets in the surrounding university buildings.
...
Or if you're not staying on that side of the city, the <ExternalLink url='https://maps.app.goo.gl/GdAKTw2SoT9XWyrFA'>Tamsui River</ExternalLink> is just as runnable. I never ran here because it wasn't near to where I stayed, but I did cycle the above route after going to Burger Su when I needed some exercise burn off all the calories - this riverside path is also vehicle-free very running-friendly.

If you're a runner who likes to actually go somewhere (and not just around in circles), the frustration of spending half your life waiting to cross the road might initially make Taipei feel like an unfriendly running city. The riverside is the great equaliser, and whether walking, running or cycling, should be expored while you're here.
...
There are no washing facilities in the room, but there's a washer and drying shared by the rooms on the sixth floor. The washer is free with detergent being provided, the dryer costs NT$50 (you need 5x NT$10 coins). As there's a clothes horse in the room, unless you're in a rush you're not going to need the dryer.
