...
export const cityImages = [
  ...
  },
  {
    ...
    alt: 'Taipei 101',
    caption: "Taipei 101 is that big building there. I didn't know that when I first arrived, but people here talked about it so reverently that I was embarrassed to ask.",
  },
  {
  ...
  },
  {
    ...
    caption: "If you cycle from the town centre to Tamsui, you'll pass Guandu Wharf, which among other things offers great views at sunset.",
  },
  {
...
I go hiking when I'm in Taipei like I go drinking when I'm in Bangkok - it's the main activity to here.

I won't go into great detail of any specific hikes - that would be an article on its own and there are other websites that cover that topic already. But if you do plan on hiking here, firstly get some appropriate clothes and shoes to wear. While some of the trails here are easy, the best ones aren't so you're going to want a proper pair of hiking shoes.
...
You can find hiking trails by Googling or asking ChatGPT or using one of many apps - I normally just search for hiking trails on Google Maps though. They're well-reviewed and people upload photos so you can easily gage how long and how difficult a hike will be. And then once you've decided, Google Maps is great for directions in Taiwan. It'll figure-out the best public transport so you can easily navigate to some very out-of-the-way places.
...
export const hikingImages = [
  ...
  },
  {
    ...
    alt: 'Wuliaojian',
    caption: 'This hike in Wulioajian is one of the more challenging ones, particularly after God defies the weather forecast and decides for no reason all day, making already at times vertical rock climbs all the more exciting.',
  },
  {
    src: `${imagePath}/hiking/caoling.jpeg`,
    alt: 'Caoling',
    caption: "Perhaps my favourite hike is in Caoling. It's not got the highest difficulty, but it's long, fresh, has great views, lots of stairs, and lots of buffalo",
  },
  {
...
Taipei has big, wide pavements, traffic is minimal for a large Asian city, and the air quality is good. So I know what you're thinking: Taipei must be a city you can run anywhere in, right?

Not so fast. You forgot that it takes anywhere from 3-5 days anytime you want to cross the road, so running around the city is pretty much a no-go unless you really don't care about having a very stop-start, mostly stop, run.

That's the bad news. The good news is that there are many good alternatives all around Taipei that are away from the roads. By far the best of these is the **riverside** - pretty much any riverside, because they all have paved cycle paths along the side that you can run along. And if you don't want to do an out-and-back run, I often ride a YouBike to a start point 10km-ish from where I want to finish, and then run back along the river.
...
The one and only place I've found in the city where it's not such an issue, is the riverside, particularly after dark. People there, apart from in these bottlenecks, tend to go for exercise, and it's so nice be around people who are able to somehow cycle, run and walk without looking at their phones the whole time.
...
It has a jogging track, but for some reason they decided that it only needed to go around three quarters of the park. After that it just ends. That's great. And even where it does exist, the very narrow track is not respected as a running track at all - it's full of walkers, old people, people in wheelchairs, groups of people, all of whom impair its ability to function as a running track. Not to mention that they decided to make it out of some very dusty clay, which you'll enjoy breathing as you're gasping for air and which makes a nice mess of your previously clean running shoes.

On weekends especially, it also gets uncomfortably busy.

Da'an Park is a lovely park to come and sit with a book or to go for a leisurely stroll, but I don't recommend coming here to run. You'll notice that more people run on the pavement outside the park, than run in the park. That's with good reason.

export const runningImages = [
  {
    src: `${imagePath}/running/riverside.jpeg`,
    alt: 'Keelung River riverside cycle path',
    caption: "Every riverside I've been to in Taipei has a cycle path that looks something like this. If you're anywhere near a riverside and want to run, this is what I suggest. It's safe an well-illuminated after dark too.",
  },
  {
    src: `${imagePath}/running/ntu-running-track.jpeg`,
    alt: 'National Taiwan University Sports Field running track',
    caption: "I don't know what it is about blue running tracks that make you want to run fast, but blue running tracks make you want to run fast. This is a nine lane, 400m running track at NTU.",
  },
  {
...
While there are some events centred around alcohol, they are in the minority with hiking and outdoor activity groups, fitness groups, and language exchange groups being much more popular. I've attended many of the events from the <ExternalLink url='https://www.meetup.com/language-friendship/'>Hiking, Cycling, Fun Activities and Social Events</ExternalLink> group consistently for both of my visits to Taipei. Some of these event attract upwards of sixty people, so it really is a great way to get to know people.
...
I've stayed in different areas around Taipei, and have loved all of them. With the exception of Ximen, I haven't been anywhere in Taipei that I didn't like. Xinyi in particular, I like, although I've never stayed around Da'an having not found suitable accommodation there, that would perhaps be my ideal area.

It has a park, NTU is nearby making it a relaxed, studenty area and the campus has a great running track, and my two most-visited vegan restaurants are nearby. With YouBike though, anywhere in the city is quickly and cheaply accessible, so I'd focus more on the accommodation than its location.
...
This room is more expensive than my previous stays, but given its then-high rating on Airbnb, coupled with how big, well-equipped and well-located it is, I figured it would be worth it, for a stress-free stay.
...
While I'm certainly not a fan of the accommodation in Taipei, I can live with it, and I expect to be back again once I've grown fed-up of angry people and cars trying to run me over again. It really is a great place to come.
