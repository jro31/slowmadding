...
Now that I've been here I can confirm that it's just like how I imagine Japan to be.
...
It doesn't run through the night, so if going to or from the airport late at night or early in the morning, you're either going to have to take a taxi or the airport bus, which does run through the night.

## Getting around Taipei

Taipei is such an incredibly easy city get around. Not only does it have an extensive and affordable MRT and bus network that can be easily navigated by English speakers, but YouBike, Taipei's bike sharing scheme, is by far the best I've ever used. Between those these, everywhere in Taipei's accessible.

A word of warning: When taking the bus remember to scan your EasyCard when getting on **and** when getting off the bus. If you forget, you'll have issues when you come to use your EasyCard again.
...
Some of these are local brands, so the prices are very fair. Expect to pay NT$800 for 1kg of protein powder.
...
I took the Decthlon one for three weeks, but after noticing a change in how I was feeling compared to before, I asked ChatGPT to compare it to the vitamin I'd been taking previously (that I'd brought with me from Europe). It told me that it was lacking in key ingredients for testosterone production (including zinc, magnesium, selenium and iron) and that I should switch over to the Leezen multivitamin, which was much more suitable.
...
Watsons also stock a vegan multivitamin with pretty packaging, but not only is it more nutrient deficient than the Decathlon, it's three times the price.
...
The only place I've found to buy vegan calcium, is of all places, PX Mart, where in bigger branches you find a decent-sized supplements section.
