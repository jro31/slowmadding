...
export const languageImages = [
  ...
  },
  {
    ...
    caption: 'The other thing I loved was how little the pictures on the signs around Taiwan left to the imagination.',
  },
  {
...
The one thing that took me a bit of getting used to in Taipei, is that if you don't look like a local person in more touristy countries, for example Thailand, then local people won't ever attempt to speak to you in the local language. The vast majority of foriegn visitor to Thailand don't speak Thai, and locals know that.
