...
export const burgerSuVeggieImages = [
  ...
  },
  {
    ...
    caption: 'Unexpectedly given the name, the menu at Burger Su is dominated by burgers, but a few other items are offered. This is a pesto mushroom wholewheat sub for NT$169.',
  },
  {
...
export const groceryStoreImages = [
  ...
  },
  {
    ...
    alt: 'Frozen vegan dumplings in Carrefour Jinan',
    caption: 'TODO',
  },
]
...
Three things that annoyed me about Taipei - Crossing the road, old people and urinals.
