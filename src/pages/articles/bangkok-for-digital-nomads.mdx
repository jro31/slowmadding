...
Also sold at Tops (see the above photo) are Dermosana magnesium effervescent tablets, which ChatGPT insists are vegan, although not overly potent. They're 145 baht for 20 tables.

Also 'likely' vegan, according to ChatGPT is the Mega Nat Mag supplement availabe in Boots, Watsons, and pretty much anywhere that sells supplements to be honest. It has a couple of ingredients that can be both plant or animal derived, so it depends how strict you're being whether you chance this one. In Boots these are 270 baht for 30 tablets.
...
Siam Plaengna is a residence, and as such is the first place that I've stayed in Bangkok where you're getting a fully-equipped apartment, complete with kitchen.

It's located north of the city centre, close to Ladprao, which is one of my favourite areas of Bangkok, but it's worth noting before staying here that this is a very local area, and there isn't too much going on in the immediate vacinity. It has local restaurants, many 7-11s and a nearby evening market. But you're a twenty minute walk from Ratchadaphisek MRT station - the nearest worthwhile local transport, and going in the other direction it's about a thirty minute walk to Chatuchak Park and its MRT/BTS stations. And if you're vegan like me, you'll find very little worthwhile within easy access. I ordered my lunch be on Grab most days that I stayed here.

I knew this before I booked, but I booked anyway, because I decided that the pluses of being in a fully-equipped apartment rather than staying in a hotel room would be worth it. And you know what? They were.
...
What you get in the room though, is a sufficiently-comfortable sofa with a good TV in the living room. There's a coffee table, but this can be easily slid-into the kitchen, leaving a big open space to do workouts in front of the TV. The bed is also perfectly comfortable to work from, and if you're one of those weird people that likes to sit at a desk, the table and chairs in the kitchen would suffice.

The room has a washing machine out on the balcony, which saves a tonne of time going to launderettes, and the Internet here is good enough. I had one day during my 28-day stay where it was a bit patchy and I struggled to do video calls, but the rest of the time it was always good enough.
...
export const siamPlaengnaImages = [
  {
    ...
    caption: "I was up on the top (7th) floo, meaning I got some great views and lots of daylight. Unforuntately my room faced north, so I didn't get to wake up with sunshine on my face, but I still loved how much light got in here.",
  },
  {
  ...
  },
  {
    ...
    caption: 'The sofa is perfectly comfortable for working from all day, and that rug under the coffee table makes sliding it out in the kitchen easy for making a big workout space.',
  },
  {
  ...
  },
  {
    ...
    caption: "The room has a balcony, but unless you're the bellend in the room below me who stands out there smoking all day, you won't find much use for it, but it does have the washing machine.",
  },
  {
