...
export const meta = {
  ...
  date: '2026-04-24T20:45:00+07:00', // TODO: Update this
...
export const mayVeggieHomeImages = [
  ...
  },
  {
    ...
    caption: "And I do like May's burgers. This is vegan teriyaki burger for 179 baht as served in the main branch.",
  },
  {
...
I noticed this the moment I walked-in my room, and noticd that there was a kettle on the desk. It only had a short cable - about 50cm, but the nearest plug was about a metre away. I had to keep and use the kettle on the floor through my entire stay. Or in the bedroom, there are no bedside tables, nor any plugs next to the bed. I ended up moving the coffee table out of the living room and next to the bed, and using my own extension cord so that I could charge my devices within arms reach while sleeping.

That worked fine, but the fact both of these issues could have been resolved by the hotel with a couple of extension cords and a cheap bedside table, but they haven't been, shows what kind of place this is.

Another example is that, being a way from the main road like you are here, you're going to order on Grab a lot. And this seems to be the only hotel left in Thailand that doesn't yet have anywhere setup for Grab drivers to drop-off food. There's just a sign telling them to contact the parking attendant, but whether he's receptive to them is another matter. To ensure that you actually get your food, you have to go downstairs and meet the driver in person, but for a hotel in 2026, that feels like madness, but is another example of how nothing here is actually designed with practicality in mind.
...
export const theSquare101Images = [
  {
    ...
    caption: "When you first walk into the room at The Square 101 you'll think it looks really, really nice. Unfortunately that sentiment is short-lived.",
  },
  {
    src: `${imagePath}/accommodation/the-square-101/bed.jpeg`,
    alt: 'The Square 101 bed',
    caption: 'The bed looks lovely, but then you realise that there are no bedside tables to keep your devices on, nor any nearby plugs.',
  },
  {
    src: `${imagePath}/accommodation/the-square-101/living-room.jpeg`,
    alt: 'The Square 101 living room',
    caption: 'My solution was to move the coffee table from the living room next to the bed, and use my own extension lead.',
  },
  {
    src: `${imagePath}/accommodation/the-square-101/desk.jpeg`,
    alt: 'The Square 101 desk',
    caption: "You'll also be greeted with a kettle on the desk, not plugged-in for some reason. Then you realise because that's as long as the cord gets, and it doesn't reach to the nearest plug that you can see to the right of the desk here, so if you want to use the kettle, you have to do so on the floor.",
  },
  {
...
My motivation for staying here was that anywhere remotely close to the centre of Bangkok feels nothing like Thailand nowadays. Everything's in English and there are more foreigners than locals, which just isn't what I'm looking for. And Samut Prakarn does tick those boxes.
...
Samutprakarn Hotel is right next to Pak Nam BTS station, which gets you into Bangkok city centre in about 40 minutes. However, when the biggest positive you can say about an area is how easy it is to leave, that should tell you something. I found very little of interest to me in the local area, and it's so far out Grab doesn't even deliver from restaurants in Udom Suk.
...
I got off to a very bad start here when I walked in and nobody was manning reception, and nor is there a bell or anything to call anyone. Tired after a day travelling, I was stood there for what felt like several minutes getting more and more irate, when a guy that had been stood next to reception the entire time having a private conversation stepped back there and said to me "sorry to keep you waiting."

He'd seen me walk in so I'd assumed he didn't actually work there, but apparently in this hotel it's just not very important for receptionists to actually to pay attention to anyone waiting at reception.

That got my goat up, and things didn't really get better from there. I found the hotel consistently annoying.

For example, I was staying on the third floor. The gym is on the second floor. Yet they lock the doors connecting each floor, meaning you have to take the lift. As the housekeepers use this, that means you can be waiting for a couple of minutes. And if you're having a stressful day and are short of time, like if you want to get on the treadmill for 30 minutes on your lunch break while working, having to wait for the lift for two minutes just because some prick's decided that guests shouldn't be able to walk between floors, will drive you fucking mad.

It doesn't bode well for fire safety either.

That's just one example of how this hotel is just very badly designed. Another is that people in adjacent buildings could see in through all the windows in my room, yet the only curtains are blackout curtains - there are no drapes. So either you have no privacy, or you're consistently in the dark. Great.

The rooms get quite stuffy too, so you're going to want to have the windows open some of the time, even with the AC on. But none of the windows have screens, so I hope you like living with bugs.

There's were two huge TVs in my room, but these too had been poorly designed, where just to connect-up my Apple TV I had to take the TV in the living room completely off the wall, only to find that the plug behind the TV was positioned so that with my Apple TV plugged-in, it couldn't actually sit flat against the wall. I ended up giving up and just used my iPad.

But honestly the worst thing about this room, is I've never stayed in a room with such bad humidity. At certainly times the tile flooring was literally sopping wet. My guess is that the person in the room below had the AC on cold a lot of the time which was cooling the tiles of my floor. The upshot was that unless I kept the temperatue in my room just as cold, the floor was consistely wet.
...
export const samutprakarnHotelImages = [
  {
    ...
    caption: "The living room is a decent size - you have plenty of space to exercise here. Note the tiles flooring though. It's a magnet for humidity and gets genuinely wet if you don't keep the AC down cold enough. Also note the building opposite. Either you're closing the blackout curtains and living in the dark, or you're in full view of them.",
  },
  {
    src: `${imagePath}/accommodation/samutprakarn-hotel/bedroom.jpeg`,
    alt: 'Samutprakarn Hotel bedroom',
    caption: 'The bedroom has similar issues with the flooring, and people being able to see in through the windows and you have noting but blackout curtains to block them with. If you look in the mirror above the desk, you can see big building outside this window.',
  },
  {
    src: `${imagePath}/accommodation/samutprakarn-hotel/kitchen.jpeg`,
    alt: 'Samutprakarn Hotel kitchen',
    caption: "The kitchen space is nice, but also kind of pointless. There's a microwave and a kettle, but there's enough space here to have some proper cooking facilities, so I'm not sure why they haven't got them.",
  },
  {
  ...
  },
  {
    ...
    caption: 'The gym is basic but has enough to do a bit of cardio or a simple weight workout.',
  },
  {
    src: `${imagePath}/accommodation/samutprakarn-hotel/japanese-garden.jpeg`,
    alt: 'Samutprakarn Hotel Japanese garden',
    caption: "Then through the gym is this little Japanese garden made with fake grass. It's not worth coming downstairs to sit out here, but I did enjoy sitting out here after a workout while I waited to stop sweating.",
  },
]
