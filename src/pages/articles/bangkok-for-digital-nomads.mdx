...
export const roomQuestSixthStayDetails = {
  dates: {
    checkIn: '2024-11-01',
    checkOut: '2024-11-14',
  },
...
<AccommodationTable details={roomQuestSixthStayDetails} />
...
export const reztBangkokDetails = {
  dates: {
    checkIn: '2025-02-13',
    checkOut: '2025-02-27',
  },
...
<AccommodationTable details={reztBangkokDetails} />

Given the ratings and reviews that Rezt has, my stay was a little disappointing.

Check-in was a bit of a mess as the guy on the desk seemed a little confused about what he was actually doing, then when I finally got into the room to find all the blinds closed, I pulled on the string to open one of them and it immediately fell off the ceiling. That was a sign of things to come, as a lot about Rezt felt it had been done a bit half-arsed.

I'm not someone who likes to cause a fuss, so on complaining that the blind had fallen down, I omitted that the kettle in the room worked... a little too well. If it was on the stand, it was boiling whether it was turned-on or not. As someone who gets through about ten cups of tea per day, this was really annoying as I couldn't put the kettle on and go and do something else, because if I forgot about it, it'd just boil and boil and boil unti I burned the hotel down, so I just got used to standing next to it instead.

It also took me a bit of time to get used to the design of the room, which sucks. There's very little surface space in the room - a couple of bedside tables, a tiny desk, and some shelves. Which is why it's completely bemusing that the room's safe is attached to the only shelf that's at a reasonable height. I therefore had to store my clothes on a high shelf that I couldn't really see comfortably, and I had to make my tea and my daily smoothies on shelf that was so low that I couldn't see without bending down, because the shelf with the safe on got in the way.

The view out of the room was non-existent as, despite being on the top (fifth) floor, I was facing the drab, windowless sides of the EmSphere building. To be fair, it's probably better than it having windows because at least this way I could sleep with the blinds open, confident that no one could see in. But still, I was envious of the rooms on the other side of the hotel, which I assume look over, among other things, Benjasiri Park.

The shower in the room wasn't great either, as it was one of those showers with two shower heads (a rainy one and a handheld one). Yet the knob that was supposed to turn one off and turn on the other didn't work properly, so no matter the setting you had water coming out of both.

All of the above was an annoyance, but it wasn't the end of the world. I'm yet to even get to the thing that pissed me off the most about this room:
...
After the class was finished, I went down to reception and asked the guy... _"the fuck?"_ I politely explained to him that I was speaking in a normal voice within daytime hours, what's he bothering me for? And he agreed. _"Yes, I know, it's very stupid,"_ he told me. Well if you know, then why did you call me to tell me? Every hotel has morons staying in it. When they make a stupid complaint, you ignore them. You don't call me and tell me about it. And if me speaking in a normal voice is audible in the adjacent rooms, then that's more of an indictment on the hotel and the soundproofing of the walls than anything else.

I left the phone unplugged for the rest of my stay so they'd have to knock on my door next time they wanted to relay a stupid complaint, but it still pissed me off that it had even got back to me. If you're someone who ever has to make phone calls or video calls, then don't stay here. You apparently can't make a normal volume call without the staff ringing your phone to tell you about it. Of all the things wrong with this hotel, this was the one that bugged me the most. You kind of want the staff to have a bit of common sense.

If I haven't put you off yet, then there are some positives about staying here too. The wifi was decent enough. 66mbps download speed and 49mbps upload speed on the one speed test I did, and it was a stable connection, which is more important. The room just about has the space for some (slightly cramped) exercise, and the bed is comfortable. And the location, for better or worse, is very, very central.

You're literally next door to EmSphere; one of the three shopping malls that comprises Em District. That means it's a very, very touristy area, but also you can get everything you need really, really conveniently.
...
The hotel is located only about 50m from Benjasiri Park, as the crow flies. Unfortunately there's no way to cut-through the back of the alleyway the hotel's on (I looked), so instead the quickest way to the park is to go out the alleyway, and then cut around past the EmSphere service entrance, but even then it's only five minutes until you're in the park, which is amazing for going for your midday run. Veganerie, one of the better vegan restaurants in Bangkok, is a short walk through the park, and in Emporium in the fourth floor food court is Talalaks, one of the better budget vegan restaurants. Other lesser places exist in the surrounding area, but those were my two go-tos while staying here.

I'll reiterate that the north end of Sukhumvit 22 is very, very touristy. And when there are tourists, services pop-up to meet their needs. What I mean is there are a lot of adult services on offer in the alley Rezt is in and in the surrounding area of soi 22. If you're a man you'll get hollered-at every time you walk down the street, which is fine, but just be aware that it's not a family-friendly area. You might not want to stay here with kids. Or a girlfriend that gets jealous easily.
...
<AccommodationTable details={sereineDetails} />
