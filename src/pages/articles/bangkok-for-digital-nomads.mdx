...
It's quite easy to find vegan protein powders all over Bangkok. It's less easy to find reasonably-priced vegan protein powders around Bangkok. The best I've come across is that in many branches of <ExternalLink url='https://maps.app.goo.gl/SngdUWcWYrFaxVaD8'>Watsons</ExternalLink>, including this one, they have a vegan protein powder at 899 baht for 1,050g.
...
export const proteinImages = [
  {
    ...
    caption: "Merry Nutrition Plant Protein is the best value vegan protein powder I've found in Bangkok at 899 baht for 1,050g. It comes in three flavours, but as I'm so sentitive to caffeine and want to be able drink it in the evenings, I've only tried the mixed berry flavour as I figure that chocolate and matcha green tea wouldn't be suitable. The berry flavour tastes pretty good though.",
  },
]
