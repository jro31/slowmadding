...
Take from that what you will. If you're a digital nomad who wants things like in their home country, but cheaper, then you might love it here. But on my most recent visits to Thailand I've regretted staying in Bangkok so long. I'd much rather spend more time in the provinces.
...
It's also worth being aware that Starbucks has gone cashless. I've not been anywhere that explicitly doesn't accept cash, but it's worth being aware that we're at the very start of Bangkok's cashless revolution, so carry a card as well, just in case.
...
The second is the sheer volume of tourists making large areas of the city unpleasant and rather soulless as businesses switch to target these free-spending foreigners. I now actively avoid areas that I considered pleasant just a couple of years ago.
...
export const proteinImages = [
  {
    ...
    caption: "Merry Nutrition Plant Protein is the best value vegan protein powder I've found in Bangkok at 899 baht for 1,050g. It comes in three flavours, but as I'm so sensitive to caffeine and want to be able to drink it in the evenings that I've only tried the mixed berry flavour as I figure that chocolate and matcha green tea wouldn't be suitable. The berry flavour tastes pretty good.",
  },
]
...
A couple of minutes after that I realised that the room doesn't have a fridge either. And as someone that makes a fruit smoothie every morning and night, being able to store my fruit is imperative. These two revelations really took the wind out of my sails for how I felt about Mitt Haus.
...
export const mittHausImages = [
  ...
  },
  {
    ...
    caption: "There's also a pay-to-use washer and dryer on the property, but seeing as it only accepts coins, I couldn't be arsed so went to the nearby launderette to do my laundry instead.",
  },
  {
...
Siam Plaengna is a residence, and as such is the first place that I've stayed as a digital nomad in Bangkok where you're getting a fully-equipped apartment, complete with kitchen.
...
As I have a five-year Thai visa and as Bangkok is the travel hub of Thailand, I can say with near-certainty that I will be back in Bangkok many more time. I definitely don't look forward to it like I used to though.
