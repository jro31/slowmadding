...
The best I've found in Bangkok is the Gateway Ekkamai branch of <ExternalLink url='https://maps.app.goo.gl/xTCwf1gVAuEwAkmp9'>MaxValu</ExternalLink>. They have a small selection of Thai teas for 35 baht for twenty tea bags. But it's only this branch, I tried in other branches of MaxValu, and they don't stock them.
