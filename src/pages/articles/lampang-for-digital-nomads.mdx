...
export const meta = {
  ...
  date: '2025-12-12T17:00:00+07:00',
...
export const guanImVeggieImages = [
  ...
  },
  {
    ...
    caption: 'This is the veggie pizza that I specifically requested be made without dairy, which it may or may not be normally. It costs 99 baht.',
  },
  {
...
export const saladboyImages = [
  ...
  },
  {
    ...
    caption: "They also sell a vegan wrap, imaginatively named 'vegan wrap', for 109 baht.",
  },
  {
    src: `${imagePath}/vegan-food/saladboy/kiwi-soda.jpeg`,
    alt: 'Saladboy kiwi soda',
    caption: 'They have some good drinks too, like this kiwi soda for 25 baht, that actually includes a piece of kiwi, which is weird.',
  },
]
...
export const leNeufImages = [
  {
    ...
    alt: 'Le Neuf bed',
    caption: "Despite three of the walls in the room facing the outside, this window lets in the only daylight that gets into the room. Other than that it's comfortable. The bed is really nice.",
  },
  {
  ...
  },
  {
    ...
    alt: 'Le Neuf desk',
    caption: 'I typically worked from the bed, but this desk was good for doing video calls and for making my smoothies every day.',
  },
  {
    src: `${imagePath}/accommodation/le-neuf/bathroom.jpeg`,
    alt: 'Le Neuf bathroom',
    caption: "I'm not sure why they put the best window in the bathroom. If that window had been above the bed, it would have been a much more welcoming room. The shower here's decent.",
  },
  {
    src: `${imagePath}/accommodation/le-neuf/balcony.jpeg`,
    alt: 'Le Neuf balcony',
    caption: 'I found little use for the balcony, although it includes a little clothes horse, so is good for drying your clothes after a run.',
  },
]
