...
export const sublimmeImages = [
  ...
  {
    src: `${imagePath}/vegan-food/sublimme/tomato-and-red-pepper-soup.jpeg`,
  ...
  {
    src: `${imagePath}/vegan-food/sublimme/protein-burger.jpeg`,
  ...
  {
    src: `${imagePath}/vegan-food/sublimme/proteic-smoothie.jpeg`,
