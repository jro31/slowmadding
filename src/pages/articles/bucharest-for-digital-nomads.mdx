...
export const meta = {
  ...
  date: '2025-08-17T13:05:00+08:00', // TODO: Update this
  title: 'Bucharest for Digital Nomads',
  description: "Romania is one of cheapest countries in the EU, yet it's capital, Bucharest, doesn't attract many digital nomads. Should you add it onto your list?",
  keywords: ['Romania'],
}
...
The currency of Romania is the Romanian leu, which has the plural form lei and is what you'll commonly see prices suffixed with. In international currency terms the abbreviation is RON.
...
The one obvious and expected deficiency in this park is the number of people that smoke here, where they make every effort to annoy as many people that are exercising as possible. Given the size of the park, it isn't as bad as in some other parks in Eastern Europe.
...
export const tineretuluiParkImages = [
  ...
  },
  {
    ...
    caption: "There are no real bottlenecks in the circuit, with the exception of one corner that home to a lot of birds. They tend to stay off the path until someone shows up with some food. Then good luck.",
  },
  {
...
The top of the bowl has a path that goes all the way around it, with one lap being 5.14km. The downside of this is that it's being on top of the bowl you're not protected from the noise of the nearby roads, and you're also out in the open with little shade.
...
export const sublimmeImages = [
  ...
  },
  {
    ...
    alt: 'Sublimme inside',
    caption: 'Sublimme is a pleasant place enough place to come and have lunch, if you can get one of the sofas at least. The plastic chairs are less appealing.',
  },
]
...
It perhaps doesn't have quite as many of the nice little touches as the room above, but I was still very impressed by how much was included. Many different teas, oil, salt and pepper to cook with, more toilet roll that I would use in a year, and even a bottle of wine in the fridge.
