...
export const vacarestiNaturalParkImages = [
  ...
  },
  {
    ...
    alt: 'Văcărești Natural Park TODO',
    caption: 'TODO',
  },
  {
...
export const izvorParkImages = [
  {
    ...
    caption: "TODO: Izvor Park is right in front of the Palace of Parliament, so you get a nice view while you run. Although if you have the energy to look at it then you're not running fast enough.",
  },
]
