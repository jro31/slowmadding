...
It's architecturally beautiful, has lots of parks, and outside of the city centre doesn't see many tourists.

My most recent stay was my third, and I'd be surprised if there aren't many more in the coming years.
...
When I first came here in 2023, it was because it was the capital city of one of the cheapest cities in the EU. And while it is still relatively cheap, prices have jumped noticeably in the three years since.

For example at Level Up, one of Bucharest's vegan restaurants, a burger with salad and fries that cost 38 lei in 2023 costs 60 lei today. I looked into staying in my 2023 Airbnb again for this most recent visit, but quickly looked elsewhere because the price had basically doubled. You'll find similar price increases across the board.
...
On the metro, your ticket is valid for one ride. On buses, trams and trolleys, your ticket is valid for 90 minutes, no matter how many rides you take.

You can always pay with contactless, however note that not all machines accept contactless.

In my experience on the trams, they have ticket machines at every door, however only one of these accepts contactless payment, so if one of the machines doesn't, go and look for a more modern machine. At Anghel Saligny metro station, only one of the ticket gates accepts contactless - the others don't. I only knew that because the security guard directed me to the right one. Wouldn't have had a clue otherwise.

So while I've always been able to pay by contactless, save for the airport bus, not all tickets machines are compatible.

export const gettingAroundImages = [
  {
    src: `${imagePath}/getting-around/tram.jpeg`,
    alt: 'Tram #1',
    caption: 'Taken on tram #1, you can see three ticket machines - one next to each door. However, only the small yellow one nearest to the camera accepts contactless. The two orange ones further down the carriage do not. I found that out the hard way by rubbing my phone all over one of those machines trying to get it to scan my card.',
  },
  {
...
Facebook is a clutter of adverts disguised as events, and there aren't many bars that are appealing to go for a beer by yourself. I find my social life here limited to a small number of active Meetup groups in Bucharest, such as <ExternalLink url='https://www.meetup.com/bucharest-digital-nomads/'>Bucharest Digital Nomads</ExternalLink>, which holds events at different bars around Bucharest, or <ExternalLink url='https://www.meetup.com/chatty-elephants-language-and-culture-exchange-events/'>Chatty Elephants</ExternalLink>, which runs very chilled Meetups in bars that are good places to meet people.
...
<ExternalLink url='https://maps.app.goo.gl/FWoP5io8EQRJmvn6A'>King Mihai I Park</ExternalLink>, north of the city centre, is where I did all of my runs in my most recent stay in Bucharest.
...
If you start at the park main park entrance, go down to the river and do a loop, it comes to about 7km, but as long as you don't mind stopping at a couple of crossings, the roads to get to the park are very running friendly, so I'd usually run from my room in Piața Victoriei, making it closer to 12km.
...
export const levelUpImages = [
  {
    ...
    caption: 'So good that even the burger is licking his lips, this is the double burger which in 2026 costs 42 lei, with salad and fries for an extra 18 lei (double the price of a couple of years ago).',
  },
  {
...
export const sublimmeImages = [
  ...
  },
  {
    ...
    caption: '...it had turned-into a pad Thai. It was still actually pretty good, but not exactly what I imagine for a salad bowl. In 2026 this costs 49 lei.',
  },
  {
  ...
  },
  {
    ...
    caption: "Or on Thursday it's this seitan and veggie wrap. It's not as healthy as some of the other options, so perhaps skip Thursday.",
  },
  {
  ...
  },
  {
    ...
    caption: 'In the continuation of calling things proteic (🤷‍♂️) this is the proteic smoothie for 33 lei.',
  },
  {
...
Sara Green is a fully vegan restaurant, outside of the city centre but nearby to my most recent room in Bucharest, so I came here quite a lot.

Burgers are what dominate the menu, but it has a lot of other things like salads and poke bowls.

The poke bowls are pre-made and everything can be taken away, so on days I didn't have the time or the energy to make lunch, I'd come and grab a poke bowl to take home for a quick and healthy lunch.
...
export const saraGreenImages = [
  ...
  },
  {
    ...
    caption: "There are healthier options on the menu, and when I wanted a quick and easy lunch I'd wander down here and get one of the pre-made poke bowls and take it home. This one is the 'Rainbow Bites' poke bowl for 36 lei.",
  },
  {
  ...
  },
  {
    ...
    caption: "They're a modern (annoying) retaurant that don't give you menus, instead giving you a QR code to scan to see the menu. It's a pain in the arse, but it does make it easier to share the menu.",
  },
]
...
export const veganGroceriesImages = [
  ...
  },
  {
    ...
    caption: "Sometimes thought they don't have any falafel so you have to make do. I call this one the vegan olive, hummus, burger baguette with lots of crisps.",
  },
  {
...
export const veganSupplementsImages = [
  ...
  },
  {
    ...
    caption: "At 102.50 lei for 30 softgels, this vegan pure omega 3 definitely isn't cheap, but I was glad to have it at all. It's definitely one of the harder vegan supplements that I source.",
  },
  {
