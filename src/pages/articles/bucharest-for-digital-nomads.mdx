...
export const levelUpImages = [
  ...
  {
    src: `${imagePath}/vegan-restaurants/level-up/no-chicken-strips-la-farfurie.jpeg`,
...
export const veganSupplementsImages = [
  {
    src: `${imagePath}/vegan-supplements/carrefour-vegan-protein-bars.jpeg`,
