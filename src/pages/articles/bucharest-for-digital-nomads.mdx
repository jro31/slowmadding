...
export const meta = {
  ...
  date: '2025-08-13T13:05:00+08:00', // TODO: Update this
...
While it's possible to buy tickets at the ticket office before boarding, it's completely unnecessary. Once the train leaves, English-speaking conductors walk down the train taking payment and printing tickets for passengers, so it's much simpler to get on without a ticket. They accept card or cash payment.
...
Bucharest hasn't escaped the plague that infects the rest of Eastern Europe, with an uncomfortably high proportion of the population doing what they can to give everyone else cancer. Men smoke, women smoke, children smoke. I'm not joking, I saw a school trip and half the kids had cigarettes.
