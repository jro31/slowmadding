...
export const meta = {
  ...
  date: '2025-07-03T17:15:00+03:00',
  title: 'Skopje for Digital Nomads',
  description: "Skopje is the unheard of and unvisited capital of North Macedonia. Just because no one else is coming here doesn't mean that you shouldn't either.",
...
export const cityImages = [
  {
    ...
    caption: 'Skopje is surrounded by mountains, which means that when the conditions are right you get some beautiful views. I took this one from the window of my Airbnb.',
  },
  {
  ...
  },
  {
    ...
    alt: 'Skopje Fortress',
    caption: "All of my runs in Skopje were along the riverside, and with good reason - it's beautiful. Apart from all the trash.",
  },
]
...
I'd tell them that it's the capital of North Macedonia, but their blank stare would continue. _"And that's near South Macedonia?"_ was one of the responses I received.
...
If you arrive in Skopje by air, as I did, then you're going to arrive at <ExternalLink url='https://maps.app.goo.gl/NThMKmaEG4JBGo4u6'>Skopje International Airport</ExternalLink>, roughly 25km east of the town centre.

There's a <ExternalLink url='https://eraktransporter.com/'>shuttle bus service</ExternalLink> from the airport. This is the most cost-effective way of travelling to the city centre, with tickets costing just 199 ден and the <ExternalLink url='https://maps.app.goo.gl/7wWF6tR1p7JN3CVs8'>last stop</ExternalLink> being nearby to Holiday Inn.

Unfortunately the buses leave very infrequently, and though my plan had been to take this shuttle bus to save money, my flight to Skopje was delayed by almost seven hours, so I was just _"fuck it, I'm not waiting around_" and took a taxi.
...
If you, like me, know little about Macedonia other than it being where Alexander the Great came from, then a lucky coincidence is that the latest 'Hardcore History' podcasts when I was here were about Alexander the Great (<ExternalLink url='https://podcasts.apple.com/us/podcast/mania-for-subjugation/id173001861?i=1000658235879'>Apple</ExternalLink>/<ExternalLink url='https://open.spotify.com/episode/7C7nWJqptAW4YOEmJNWEa6'>Spotify</ExternalLink>).
...
export const gettingAroundImages = [
  {
    ...
    alt: 'Skopje bus',
    caption: "For unknown reasons, Skopje's buses, both single and double-decker, are copies of London's red buses.",
  },
]
...
The only regular event I'm aware of here is the Sunday Meetup from the <ExternalLink url='https://www.facebook.com/share/g/1AZCtbopkF'>Skopje Expats ::: Events</ExternalLink> Facebook group. Every Sunday at 5pm around a dozen or so people, a mix of regulars and new people, meet at <ExternalLink url='https://maps.app.goo.gl/hxCDcxk6qZtn6Goe8'>Café Samo</ExternalLink> for an English-language social.
...
All of my runs in Skopje were along the riverside. I would walk down to the nearest point of the river from my room, which happened to be the <ExternalLink url='https://maps.app.goo.gl/Jt7gXtwKmc5uxwUR9'>Stone Bridge</ExternalLink> in front of the Alexander statue, and I'd either turn left or turn right and just run along the riverside.
...
<ExternalLink url='https://maps.app.goo.gl/fbtjK6ckEe65EDo1A'>City Park</ExternalLink> is the imaginatively named main park in the city of Skopje. It's attached to the riverside, so can be combined with riverside runs. Honestly though, I didn't really like it.
...
There's a small loop of a <ExternalLink url='https://maps.app.goo.gl/YoHGS2qCh5HvUr5o9'>rubberised running surface</ExternalLink> with a maze inside it. But when I say small, I do mean small. I'd be surprised if one loop is 100m, so good luck going around in circles. But hey, if you want to do sprints it might be suitable.

export const cityParkImages = [
  {
    src: `${imagePath}/running/city-park/path.jpeg`,
    alt: 'City Park path',
    caption: "City Park isn't overly pleasant, but it does have wide paths.",
  },
  {
...
I only came to Vodno once during my stay, when I was scouting places to run. I went left at the wall because I was following someone who had hiking gear on and who looked like they knew where they were going, and it was a lovely hike up to the <ExternalLink url='https://maps.app.goo.gl/Cw74EN961MbXFw898'>Middle Vodno</ExternalLink>. Natural, peaceful with beautiful views.
...
export const vodnoImages = [
  ...
  },
  {
    ...
    alt: 'Vodno trailhead',
    caption: "About 20 metres after the rounded wall you'll see this red and white arrow pointing to Middle Vodno, right above some red and white spray paint. I took this to mean that if I followed the red and white markings on the trail it'd get me to Middle Vodno. Which it did.",
  },
  {
...
export const veganFoodImages = [
  ...
  },
  {
    ...
    caption: "Zen Gusto is a non-vegan restaurant right in the city centre, but it has a couple of vegan options like the vegan feta sandwich for 220 ден.",
  },
  {
...
export const paradiseFoodImages = [
  ...
  },
  {
    ...
    caption: 'Paradise Food is spaced over two floors. Upstairs is all tables so even coming at peak lunchtime I was always able to one to myself.',
  },
  {
...
export const groceriesImages = [
  {
    ...
    caption: 'Eastern Europe sure does love vegan cheese for some reason. Here it is in Ramstore supermarket, but more importantly, look at all the hummus!',
  },
  {
    src: `${imagePath}/vegan-food/groceries/vegan-frozen-food.jpeg`,
    alt: 'Ramstore supermarket vegan frozen food',
    caption: "You won't find many intentionally vegan items in the supermarkets, but in Ramstore they did have this small selection of vegan frozen mock meats.",
  },
  {
    src: `${imagePath}/vegan-food/groceries/paradise-food-tofu.jpeg`,
    alt: 'Paradise Food tofu',
    caption: "Tofu isn't stocked in any of the supermarkets here, which is a bit odd. I can't remember going to another city where that was the case. Luckily Paradise Food make and sell their own, so you can still pick some up if you need it.",
  },
  {
...
The room is very spacious, particularly the living room, and is equipped with everything that you might need, barring a microwave. Lots of cooking equipment and utensils, a washing machine, and lots of comfortable chairs to sit on.
...
export const apartmentImages = [
  {
    ...
    caption: "The main reason I booked this room was to stay somewhere with a lot of natural light. The slanted windows face south (the same in the bedroom). In that sense it's absolutely glorious, not to mention the living room has more than enough space to exercise and plenty of comfortable seating.",
  },
  {
    src: `${imagePath}/apartment/table.jpeg`,
    alt: 'Apartment table',
    caption: "Although there's a desk in the bedroom, this is the best workstation, not to mention a great place to do video calls. Behind the middle chair are the windows, and every person I spoke to told me that they though I had a fake background it was so beautiful.",
  },
  {
  ...
  },
  {
    ...
    alt: 'Apartment bed',
    caption: 'I arrived at night, but apart from the first couple of nights when it was cold, my entire stay was through a heatwave, meaning I had to sleep with the windows open. People smoking, and occasional loud noises at night made that mildly annoying.',
  },
  {
  ...
  },
  {
    ...
    caption: 'The view from the apartment is quite something, facing south to Vodno.',
  },
  {
  ...
  },
  {
    ...
    caption: "The apartment's washing machine is in the bathroom, although I was only given three detergent capsules so had to buy my own.",
  },
  {
    src: `${imagePath}/apartment/drying-room.jpeg`,
    alt: 'Apartment drying room',
    caption: "In lieu of a balcony, you have what I'd call a drying room. It has a drying rack, and that was all I used it for.",
  },
  {
