...
export const meta = {
  ...
  date: '2026-03-11T20:55:00+07:00',
...
In my many years in Thailand I've had to deal with immigration offices all over the country, and during my first stay in Ubon I was here when I had to do my 90-day report, so I wandered down to the <ExternalLink url='https://maps.app.goo.gl/tJDvupvyNvLH3BcGA'>Ubon Ratchathani Immigration Office</ExternalLink>.
...
Another option is drinking your way through Ubon's craft beer scene. Sadly Heisenberg's, my favourite craft beer bar from my first stay, had closed down by my second, but <ExternalLink url='https://maps.app.goo.gl/bEqJQNJm8vGw62Wc7'>Ubon Tap Taste House Craft Beer & Foods</ExternalLink> is another option.
...
export const runningImages = [
  ...
  },
  {
    ...
    caption: "Unfortunately you'll hit a point where construction will halt your path (unless you're willing to run in the road), but enough of it's been completed that you can still have a good run here.",
  },
  {
    src: `${imagePath}/running/huai-wang-nong-under-construction.jpeg`,
    alt: 'Huai Wang Nong under construction',
    caption: "This is how the northern half of the lake looked during my first stay, but if you're reading this a couple of years later the work might be completed, and once it is it'll be an amazing place to come for a walk or run. I'd guess one lap of the lake will be about 8km.",
  },
  {
...
export const veganFoodImages = [
  {
    ...
    caption: 'The stir-fried plant-based crispy pork with noodles at Grow Up Eatery and Farm will cost you 105 baht.',
  },
  {
    src: `${imagePath}/vegan-food/grow-up-eatery-and-farm-power-kale-smoothie.jpeg`,
    alt: 'Grow Up Eatery and Farm power kale smoothie',
    caption: "They also sell many kinds of smoothies made with oat milk. This is the 'Power Kale' smoothie, made from kale, apple, pineapple, banana, oat milk and granola for 110 baht.",
  },
  {
    ...
    caption: 'Another of the plant-based meat dishes at Grow Up Eatery and Farm is this stir-fried plant-based crispy pork with shiitake mushrooms and brown rice, which costs 139 baht.',
  },
  {
  ...
  },
  {
    ...
    caption: 'The store at Utthayan Bunniyom sells lots of great vegan prduce, including these loose teas, although unfortunately not any loose leaf green tea.',
  },
  {
    src: `${imagePath}/vegan-food/utthayan-bunniyom-store-closed.jpeg`,
    alt: 'Utthayan Bunniyom store closed',
    caption: "But just be aware that the days that Utthayan Bunniyom are open are not reliable, as I found out the hard way with them being closed from the 27th February to the 10th of March, covering my entire second stay in Ubon.",
  },
  {
    src: `${imagePath}/vegan-food/utthayan-bunniyom-market.jpeg`,
    alt: 'Utthayan Bunniyom market',
    caption: "Out the front of Utthayan Bunniyom is a little market that's a great place to stock-up on fruit.",
  },
]
...
I said after staying at The Outside Inn that next time I'm in Ubon that _"I'll look for a more standard hotel... even if it means paying three times the price."_ That's pretty much what I did.
...
export const b2UbonAirportPremierHotelImages = [
  ...
  },
  {
    ...
    caption: 'My room had a disabled bathroom, and I loved that. I always try to use disabled toilets anyway, but here I had an entire disabled toilet to myself. Those bars are really useful for hanging things on.',
  },
  {
