...
export const meta = {
  ...
  date: '2023-07-09T17:00:00+03:00', // TODO: Update this
...
As my experience with using Airbnb to find accommodation has been overwhelmingly positive, I want to detail the process that I go through to choose the place that I stay.
...
If I'm staying in an Airbnb, it'll typically be for a month or longer. When you're staying somewhere for that long, all it takes is one person booking one night during those dates, and that room is no longer available. Leaving it until the last minute to find a place to stay, you're going to be left with the places that no one else wanted.
...
My strategy for doing this may seem a little unconventional, but it's consistently worked for me. The first thing that I do is go onto <ExternalLink url='https://www.happycow.net/'>Happy Cow</ExternalLink>. Happy Cow is an app for finding vegan/vegetarian food, and is the biggest database of vegan/vegetarian restaurants I've ever found. I'll search for the town or city that I'm going to, and on the results page will filter to just show vegan restaurants. This will show a map of all the vegan restaurants in the centre of the town or city that I'm going to. I'll zero my Airbnb search onto any areas that have clusters of vegan restaurants. Why?
...
I also really value green, open space. This is partly because I think it's important to surround yourself with nature as much as you can, and partly because I like to run, and parks are the best place to do that. So within the vegan-friendly areas that I identified on Happy Cow, I'll go onto Google Maps, and look for any decent-sized parks. Looking at the parks in street view can really give you a good idea of what it's like.
