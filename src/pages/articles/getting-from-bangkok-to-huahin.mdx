...
export const imagePath = '/images/articles/getting-from-bangkok-to-huahin'

export const stateRailwayOfThailandImages = [
  {
    src: `${imagePath}/state-railway-of-thailand/search-box.png`,
...
export const ekkamaiBusTerminalImages = [
  {
    src: `${imagePath}/ekkamai-bus-terminal/huahin-kiosk.jpeg`,
  ...
  {
    src: `${imagePath}/ekkamai-bus-terminal/huahin-bus-times.jpeg`,
