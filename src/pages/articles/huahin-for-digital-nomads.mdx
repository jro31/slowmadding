...
import citySoi98Image from '#/huahin-for-digital-nomads/city/soi-98.jpeg'
import cityWelcomeToHuahinImage from '#/huahin-for-digital-nomads/city/welcome-to-huahin.jpeg'
...
import baanYokmhaneeFrontViewImage from '#/huahin-for-digital-nomads/baan-yokmhanee/front-view.jpeg'
import baanYokmhaneeOutsideImage from '#/huahin-for-digital-nomads/baan-yokmhanee/outside.jpeg'

import skyVillaBedImage from '#/huahin-for-digital-nomads/sky-villa/bed.jpeg'
import skyVillaRoomImage from '#/huahin-for-digital-nomads/sky-villa/room.jpeg'
import skyVillaBathroomImage from '#/huahin-for-digital-nomads/sky-villa/bathroom.jpeg'
import skyVillaCondomSignImage from '#/huahin-for-digital-nomads/sky-villa/condom-sign.jpeg'
import skyVillaBalconySinkImage from '#/huahin-for-digital-nomads/sky-villa/balcony-sink.jpeg'
import skyVillaBalconySunriseImage from '#/huahin-for-digital-nomads/sky-villa/balcony-sunrise.jpeg'
import skyVillaOutsideImage from '#/huahin-for-digital-nomads/sky-villa/outside.jpeg'
import skyVillaInformationFolderImage from '#/huahin-for-digital-nomads/sky-villa/information-folder.jpeg'
import skyVillaHuahinNightlifeInformationImage from '#/huahin-for-digital-nomads/sky-villa/huahin-nightlife-information.jpeg'
...
import huahinVeganJackfruitTunaDipWithVegetablesImage from '#/huahin-for-digital-nomads/huahin-vegan/jackfruit-tuna-dip-with-vegetables.jpeg'
...
import huahinVeganMangoSpringRollsImage from '#/huahin-for-digital-nomads/huahin-vegan/mango-spring-rolls.jpeg'
import huahinVeganVeganPenneWithPestoImage from '#/huahin-for-digital-nomads/huahin-vegan/vegan-penne-with-pesto.jpeg'
import huahinVeganVeganPumpkinCarbonaraImage from '#/huahin-for-digital-nomads/huahin-vegan/vegan-pumpkin-carbonara.jpeg'
...
import huahinVeganPanangVegetableCurryImage from '#/huahin-for-digital-nomads/huahin-vegan/panang-vegetable-curry.jpeg'
...
import sAndSVegetableJalfreziImage from '#/huahin-for-digital-nomads/s-and-s/vegetable-jalfrezi.jpeg'
import sAndSSaagAlooImage from '#/huahin-for-digital-nomads/s-and-s/saag-aloo.jpeg'
import sAndSChapatiImage from '#/huahin-for-digital-nomads/s-and-s/chapati.jpeg'
import sAndSCholayAlooImage from '#/huahin-for-digital-nomads/s-and-s/cholay-aloo.jpeg'
import sAndSMixedVegetableBaltiImage from '#/huahin-for-digital-nomads/s-and-s/mixed-vegetable-balti.jpeg'
import sAndSVegetableKormaImage from '#/huahin-for-digital-nomads/s-and-s/vegetable-korma.jpeg'
import sAndSAlooMutterImage from '#/huahin-for-digital-nomads/s-and-s/aloo-mutter.jpeg'
import sAndSInsideImage from '#/huahin-for-digital-nomads/s-and-s/inside.jpeg'
import sAndSInside2016Image from '#/huahin-for-digital-nomads/s-and-s/inside-2016.jpeg'

import ogenHummusOgenImage from '#/huahin-for-digital-nomads/ogen/hummus-ogen.jpeg'
import ogenTabouliSaladImage from '#/huahin-for-digital-nomads/ogen/tabouli-salad.jpeg'
import ogenShakshukaImage from '#/huahin-for-digital-nomads/ogen/shakshuka.jpeg'
import ogenFalafelBallsImage from '#/huahin-for-digital-nomads/ogen/falafel-balls.jpeg'
import ogenPitaFalafelImage from '#/huahin-for-digital-nomads/ogen/pita-falafel.jpeg'
import ogenFalafelSetImage from '#/huahin-for-digital-nomads/ogen/falafel-set.jpeg'
import ogenMangoSmoothieImage from '#/huahin-for-digital-nomads/ogen/mango-smoothie.jpeg'

import runningStravaImage from '#/huahin-for-digital-nomads/running/strava.jpeg'

import socialChangMarketImage from '#/huahin-for-digital-nomads/social/chang-market.jpeg'

export const meta = {
  author: 'Jethro Williams',
  date: '2024-03-03T10:00:00+07:00', // TODO: Update this
...
export const skyVillaHuaHinGuesthouseDetails = {
  dates: {
    checkIn: '2024-02-17',
    checkOut: '2024-03-02',
  },
...
export const baanYokmhaneeImages = [
  ...
  {
    src: baanYokmhaneeFrontViewImage,
...
export const skyVillaImages = [
  {
    src: skyVillaBedImage,
    alt: 'Sky Villa Hua Hin Guesthouse bed',
    caption: "At 42m², the room is pretty huge if you're travelling alone and only have a suitcase. With all the curtains open loads of natural light gets in, which is great for people who like to rise with the sunrise like me.",
  },
  {
    src: skyVillaRoomImage,
  ...
  {
    src: skyVillaBalconySinkImage,
    alt: 'Sky Villa Hua Hin Guesthouse balcony',
    caption: 'My room was facing south so got a good amount of sunlight all day. I loved sitting on the balcony in the sun and having a cup of tea.',
  },
  {
    src: skyVillaBalconySunriseImage,
  ...
  {
    src: skyVillaHuahinNightlifeInformationImage,
...
export const huahinVeganImages = [
  ...
  {
    src: huahinVeganJackfruitTunaDipWithVegetablesImage,
  ...
  {
    src: huahinVeganMangoSpringRollsImage,
  ...
  {
    src: huahinVeganVeganPumpkinCarbonaraImage,
  ...
  {
    src: huahinVeganPanangVegetableCurryImage,
...
export const sAndSImages = [
  {
    src: sAndSVegetableJalfreziImage,
  ...
  {
    src: sAndSMixedVegetableBaltiImage,
  ...
  {
    src: sAndSInside2016Image,
    alt: 'S and S Indian Food inside in 2016',
    caption: "This is how it looked when I went to its prior location in 2016. Three boys loudly playing computer games in the middle of the restaurant didn't exactly make for a tranquil atmosphere. Unless my eyes deceive me, the boy in the middle now works in the restaurant as a waiter.",
  },
]

export const ogenImages = [
  {
    src: ogenHummusOgenImage,
    alt: 'Ogen hummus',
    caption: "Mi amor, this is listed in the menu as 'Hummus Ogen' and costs 180 baht with a pita bread.",
  },
  {
    src: ogenTabouliSaladImage,
...
export const socialImages = [
  {
    src: socialChangMarketImage,
    alt: 'Chang Market',
    caption: "If you go down soi 88 far enough that you cross the railway tracks you get to Chang Market. I don't recommend it, the music was terrible when I went and it was so loud that you wouldn't be able to have a conversation with your friends even if you have any, I just thought this was a nice picture.",
  },
]
...
That felt true on my first visit to Huahin in 2016, as a short break while living in Bangkok. By the time I returned as a digital nomad in 2023 I found that Huahin had become a haven for foreign retirees, and when a town in Thailand becomes inundated with male retirees who have a much higher disposable income than the average Thai, the town will change to part them from that money, much to their delight.

Don't make the mistake of thinking Huahin is equivalent to Pattaya or Patong in the services it offers; it's not even close. This is still a very sleepy town in comparison. However, a couple of new bar areas have sprung up since my first visit, and there's no shortage of massage parlours.

Your main motivation to visit should be that Huahin's just a nice, relaxed place to be. There's really not much going on, but if you like to merely exist, then Huahin's a great place to exist. That, and it's the quickest and easiest place that I've found in Thailand to <Link href='/articles/getting-a-visa-extension-in-huahin'>get a visa extension</Link> so it's worth the trip down here just for that.

It's a town known for its beach. If you come here, that's probably partly why, but if that's your motivation, I'd say don't bother. I'm not really a big fan of beaches to begin with, so perhaps it's not my opinion you should seek on the topic, but to me they're just sandy and hot. There are two reasons that I like going to the beach.
...
<AccommodationTable details={skyVillaHuaHinGuesthouseDetails} />

On booking.com, Sky Villa is named _'Sky Villa Hua Hin Guesthouse - Adults-Only'_. When I booked I took the 'Adults-Only' part to mean that they don't want screaming kids making a mess and disturbing people who're relaxing by the pool, but I didn't read anymore into it than that. It was only once I arrived and saw the information folder in the bedroom, with 'The Hotel for Single Travellers' written in big writing next to pictures of scantily-clad women that I was like oh... I'm staying at a sex hotel. Or at least I think that's the way they try to market themsevles.

Some not very subtle hints lead me to believe it's a German-owned hotel, and you know what they're like. Beyond the information folder being overly provocative though, it feels like a pretty normal hotel.

I came here from Pattaya where I'd done way too much partying, and was on much more of a health-kick than I was concerned about going out to the bars, and I didn't really see any other evidence of sexed-up single people bringing girls back. It seemed to mostly be couples staying here, so I think other people took the 'Adults-Only' thing like I did. This hotel seems to attract no more horn-dogs than anywhere else.

That being said, it's a really great place. I was in the Deluxe Double Room with Balcony, which at 42m² is the bigger of the two room sizes they offer (smaller rooms are 32m²), and feels absolutely huge for someone travelling alone. Double bed, sofa, desk, and still loads of empty space which is great for exercising. The large windows let in a tonne of natural light and I really enjoyed sitting out on the balcony with a cup of green tea in the mornings. It's a really great place to just be relaxed.

Out on the balcony you also have a second sink; great for cleaning your blender after making a smoothie, and in the bathroom, the shower's a stand-out feature because of how powerful it is. Intenet here is lightning fast and very reliable, making it much more digital nomad friendly than Baan Yokmhanee. In terms of the room, the only thing that left me a little bit wanting, was the TV was a bit shitty. It was fine to use for workouts once I'd plugged my Apple TV in, but I didn't bother watching any Netflix on it. It was too small and old.

The room is made-up everyday, and one thing I really loved is that as well as giving you a couple of bottles of drinking water, as is standard in most hotels, they filled-up the kettle with drinking water everyday. It's about a 1.5l kettle, so getting that much free water was nice, because it's about an eight minute walk to the nearest 7-11 where carrying water back in the Huahin sun was a bit of a chore.

In terms of facilities offered by the hotel, the most obvious one is the pool, and that's how I justified the extra cost of staying here to myself. Yet as is standard, I spent everyday here planning on going for a swim in the pool, or at least going and reading my book next to the pool, but never actually did. I'm not sure if I've ever made it to a swimming pool in all my time as a digital nomad, so why I continue to think that paying extra to be in hotels with pools is a good use of money, I'm not sure. But from a distance the pool looked really nice. Even better because no kids are allowed here.

The location is on soi 98, a very short walk from Blueport shopping mall. Like Baan Yokmhanee, the beach is very close (across a main road), but it's a bit of a walk into the town centre. I don't particularly mind that, and I actually like this area, but if you're someone who needs to be in the centre of things, this place might not be for you.

If I had to level one criticism, and this is going to sound pedantic but it really annoyed me, it's that the key that they give you for the room includes a large block of plastic that you need to insert to get power in the room. No problem, I thought, I'll just disassemble the key like I normally do when hotels feel the need to give me giant keys.

Nope, they've literally soldered the key ring together so you cannot take any parts of it off, so you have to log-around this giant block of plastic with you everywhere you go. That was an annoyance when I was walking and it was just sitting in my pocket, but on a couple of occasions when I woke up early, it stopped me going for a run.

The reception is only staffed from 8:30am to 5:30pm. I had a couple of days when I was up early (about 6am), thought to myself _"Wow, this would be a nice morning to go for a run on the beach,"_ but then remembered that with reception being closed, I couldn't leave my key there so would have to carry this giant block of plastic on my run so decided to do yoga instead.

When it's literally just a small key that you need to get into your room, and an electronic tag about the size of 10 baht coin that you need to open the main door to the hotel once reception is closed, it's madness that you're forced to haul-around a giant block of plastic with you all day.

But it's ok, I'm over it. Other than that it's a really great place. The staff were incredibly friendly, and I'm pretty sure one of them was stalking me, which always makes you feel good about yourself.
...
On my first two visits to Huahin, Huahin Vegan was located in the now defunct Huahin Shopping Mall. By my third the shopping mall had closed down and the restaurant had moved to a bigger premises on the corner of soi 82, hiring new staff in the process who, as I learned, weren't really up to snuff.

The moment that sticks in my mind is I went to the restaurant, had a look at the menu for a couple of minutes and was ready to order. I tried to get the attention of one of the waitresses who, to be fair, was quite busy. But rather than acknowledging me, telling me she'll be there in a minute, anything like that, she would look at me, see I wanted to order, and ignore me. This went on for what felt like a good five minutes. Eventually though, she found the time to come over to my table.

On the table next to mine were a couple. They'd been looking at the menu and been ready to order for all of about three seconds. And when this waitress came over to our tables, she decided, despite seeing me wanting to order for several minutes now, that she'd go to their table first, at which point my patience at the lack of acknoewledgement finally ran out and I very audibly exclaimed _"well fuck me then I guess."_

In part due to my annoyance at this waitress, and in part down to the embarrassment of momentarily losing control of my emotions, I didn't return to Huahin Vegan for well over a week, despite it being by far the best source of vegan food in Huahin and a place I'd previously go to every day or two. And while I did eventually swallow my pride and go back, there was now an obvious awkwardness between me and this waitress, who regrettably had persisted in existing despite my silent wishes.

The two minutes of your life that you spent reading that story and are never getting back do nothing to detract from the fact there is no better place to get vegan food in Huahin. Even if I no longer hold the front-of-house staff with the regard I once did (to be fair, the rest of the staff are all excellent), the food has here always been high quality.

It's a fully-vegan menu of a mix of foreign and local foods, typically costing about 150 baht per dish. The plates aren't huge so I'd usually get a couple of things, but even that doesn't break the bank.

It's a fairly dire vegan scene in Huahin, so this restaurant is a God-send.
...
<ExternalLink url='https://www.happycow.net/reviews/s-and-s-indian-restaurant-hua-hin-44252'>Visit S&S on Happy Cow</ExternalLink>
...
That being said, vegan choices are marked on the menu, which is always big for me. I like to be able to order without asking staff which items I can have. And they do really good hummus, and if you know me, forget about love, money and romantic gestures, the key to my heart is good quality hummus.
...
<ExternalLink url='https://www.happycow.net/reviews/ogen-hua-hin-320360'>Visit Ogen on Happy Cow</ExternalLink>
