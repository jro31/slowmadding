...
export const ogenImages = [
  ...
  },
  {
    ...
    alt: 'Ogen shakshuka',
    caption: "This is 'shakshuka spinach and champignon mushroom.' I don't know what shakshuka is, but they seem to be missing some commas in there somewhere. Whatever it is, it's listed on the menu as vegan, and was pretty tasty. It cost 260 baht.",
  },
  {
...
On my first two visits to Huahin, Huahin Vegan was located in the now defunct Huahin Shopping Mall. By my third the shopping mall had closed down and the restaurant had moved to a bigger premesis on the corner of soi 82, hiring new staff in the process who, as I learned, weren't really up to snuff.

The moment that sticks in my mind is I went to the restaurant, had a look at the menu for a couple of minutes and was ready to order. I tried to get the attention of one of the waitresses who, to be fair, was quite busy. But rather than acknowledging me, telling me she'll be there in a minute, or anything like that, she would look at me, see I wanted to order, and just ignore me. This went on for what felt like a good five minutes. Eventually though, she found the time to come over to my table.
...
In part due to my annoyance at this waitress, and in part down to the embarrassment of momentarily losing control of my emotions, I didn't return to Huahin Vegan for well over a week, despite it being by far the best source of vegan food in Huahin and a place I'd previously go every day or two. And while I did eventually swallow my pride and go back, there was now an obvious awkwardness between me and this waitress, who regrettably had persisted in existing despite my silent wishes.
...
TODO: Add photos (including one from 2016)
