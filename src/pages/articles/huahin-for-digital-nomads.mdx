...
The Huahin immigration office is on the basement floor of the <ExternalLink url='https://goo.gl/maps/WP5vWJEqAppCoxxi6'>Bluport shopping mall</ExternalLink>. If you do need to attend an immigration office at any point (for a visa extension or a 90-day report, for example) then I recommend doing it in Huahin.
...
export const huahinVeganImages = [
  ...
  },
  {
    ...
    caption: "The tofu scramble with roasted mushrooms is unexpectedly filling and only costs 160 baht.",
  },
  {
