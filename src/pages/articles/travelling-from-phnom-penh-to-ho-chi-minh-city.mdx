...
export const imagePath = '/images/articles/travelling-from-phnom-penh-to-ho-chi-minh-city'

export const giantIbisPhnomPenhTicketOfficeImages = [
  {
    src: `${imagePath}/giant-ibis-phnom-penh-ticket-office.jpeg`,
...
export const giantIbisChargingPortsImages = [
  {
    src: `${imagePath}/giant-ibis-charging-ports.jpeg`,
...
export const giantIbisHcmcTicketOfficeImages = [
  {
    src: `${imagePath}/giant-ibis-hcmc-ticket-office.jpeg`,
