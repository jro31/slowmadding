...
export const meta = {
  ...
  description: 'Cambodia uses two currencies. Which one should you bring with you?',
}
...
export const rielImages = [
  {
    src: rielImage,
    alt: 'Riel',
    caption: 'Riel bills come in denominations of 100, 500, 1,000, 5,000, 10,000, 20,000 and 50,000.'
  }
]
...
Riel bills only go as large as ៛50,000 (which converts to $12.50), so if you go to an ATM and withdraw 800,000 riel ($200), you'll be given your cash in sixteen ៛50,000 bills. These will be accepted everywhere.
