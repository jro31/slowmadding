    ...
    <Popover {...props}>
      ...
      <Transition>
        ...
        >
          <PopoverPanel
            focus
            className="fixed inset-x-4 top-8 z-50 origin-top rounded-3xl bg-white p-8 ring-1 ring-zinc-900/5 md:absolute md:inset-x-1/4 md:top-12 dark:bg-zinc-900 dark:ring-zinc-800"
          >
